...
s.connect((HOST, PORT))
print(s.recv(1024))
iv = 'f703eda870c1e89650481a899115ccd6'
cipher = 'f703eda870c1e89650481a899115ccd64aabdc97d21ca3305d3eaa8aa9ec1c5f1e52069b86592045be00f2ead14f2fb4'
...
def call_oracle(up_cipher):
    s.send(b'2\n')
    s.send('{}, {}\n'.format(up_cipher, iv).encode())
    time.sleep(0.2)
    res = s.recv(1024).decode()
    return 1,  res[res.find('Enter text:')+15:res.find('Enter text:')+20]

...
public class ComponentActivity extends androidx.core.app.ComponentActivity implements ContextAware, LifecycleOwner, ViewModelStoreOwner, HasDefaultViewModelProviderFactory, SavedStateRegistryOwner, OnBackPressedDispatcherOwner, ActivityResultRegistryOwner, ActivityResultCaller {
    ...
    public ComponentActivity() {
        ...
        this.mOnBackPressedDispatcher = new OnBackPressedDispatcher(new Runnable() {
            /* class androidx.activity.ComponentActivity.RunnableC00011 */
        ...
        this.mActivityResultRegistry = new ActivityResultRegistry() {
            /* class androidx.activity.ComponentActivity.C00022 */
            ...
            public <I, O> void onLaunch(final int requestCode, ActivityResultContract<I, O> contract, I input, ActivityOptionsCompat options) {
                ...
                final IntentSender.SendIntentException e;
                ...
                if (synchronousResult != null) {
                    new Handler(Looper.getMainLooper()).post(new Runnable() {
                        /* class androidx.activity.ComponentActivity.C00022.RunnableC00031 */

                        public void run() {
                            C00022.this.dispatchResult(requestCode, synchronousResult.getValue());
                        }
                    });
                    return;
                }
                ...
                if (ActivityResultContracts.RequestMultiplePermissions.ACTION_REQUEST_PERMISSIONS.equals(intent.getAction())) {
                    ...
                    try {
                        ...
                        optionsBundle2 = optionsBundle;
                        new Handler(Looper.getMainLooper()).post(new Runnable() {
                            /* class androidx.activity.ComponentActivity.C00022.RunnableC00042 */

                            public void run() {
                                C00022.this.dispatchResult(requestCode, 0, new Intent().setAction(ActivityResultContracts.StartIntentSenderForResult.ACTION_INTENT_SENDER_REQUEST).putExtra(ActivityResultContracts.StartIntentSenderForResult.EXTRA_SEND_INTENT_EXCEPTION, e));
                            }
                        });
                    }
                } else {
        ...
        if (getLifecycle() != null) {
            if (Build.VERSION.SDK_INT >= 19) {
                getLifecycle().addObserver(new LifecycleEventObserver() {
                    /* class androidx.activity.ComponentActivity.C00053 */
            ...
            getLifecycle().addObserver(new LifecycleEventObserver() {
                /* class androidx.activity.ComponentActivity.C00064 */
            ...
            getLifecycle().addObserver(new LifecycleEventObserver() {
                /* class androidx.activity.ComponentActivity.C00075 */
            ...
            getSavedStateRegistry().registerSavedStateProvider(ACTIVITY_RESULT_TAG, new SavedStateRegistry.SavedStateProvider() {
                /* class androidx.activity.ComponentActivity.C00086 */
            ...
            addOnContextAvailableListener(new OnContextAvailableListener() {
                /* class androidx.activity.ComponentActivity.C00097 */

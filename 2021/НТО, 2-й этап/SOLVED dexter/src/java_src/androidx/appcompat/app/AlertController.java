...
public class AlertController {
    ...
    private final View.OnClickListener mButtonHandler = new View.OnClickListener() {
        /* class androidx.appcompat.app.AlertController.View$OnClickListenerC00271 */
    ...
    private void setupView() {
        ...
        View parentPanel = this.mWindow.findViewById(C0021R.C0024id.parentPanel);
        View defaultTopPanel = parentPanel.findViewById(C0021R.C0024id.topPanel);
        View defaultContentPanel = parentPanel.findViewById(C0021R.C0024id.contentPanel);
        View defaultButtonPanel = parentPanel.findViewById(C0021R.C0024id.buttonPanel);
        ViewGroup customPanel = (ViewGroup) parentPanel.findViewById(C0021R.C0024id.customPanel);
        setupCustomContent(customPanel);
        View customTopPanel = customPanel.findViewById(C0021R.C0024id.topPanel);
        View customContentPanel = customPanel.findViewById(C0021R.C0024id.contentPanel);
        View customButtonPanel = customPanel.findViewById(C0021R.C0024id.buttonPanel);
        ...
        if (!hasButtonPanel) {
            if (contentPanel != null) {
                View spacer = contentPanel.findViewById(C0021R.C0024id.textSpacerNoButtons);
                if (spacer != null) {
        ...
        if (hasTopPanel) {
            ...
            if (!(this.mMessage == null && this.mListView == null)) {
                divider = topPanel.findViewById(C0021R.C0024id.titleDividerNoCustom);
            }
            if (divider != null) {
                divider.setVisibility(0);
            }
        } else if (contentPanel != null) {
            View spacer2 = contentPanel.findViewById(C0021R.C0024id.textSpacerNoTitle);
            if (spacer2 != null) {
    ...
    private void setScrollIndicators(ViewGroup contentPanel, View content, int indicators, int mask) {
        final View indicatorUp = this.mWindow.findViewById(C0021R.C0024id.scrollIndicatorUp);
        final View indicatorDown = this.mWindow.findViewById(C0021R.C0024id.scrollIndicatorDown);
        ...
        if (indicatorUp != null || indicatorDown != null) {
            if (this.mMessage != null) {
                this.mScrollView.setOnScrollChangeListener(new NestedScrollView.OnScrollChangeListener() {
                    /* class androidx.appcompat.app.AlertController.C00282 */
                ...
                this.mScrollView.post(new Runnable() {
                    /* class androidx.appcompat.app.AlertController.RunnableC00293 */
            ...
            if (listView != null) {
                listView.setOnScrollListener(new AbsListView.OnScrollListener() {
                    /* class androidx.appcompat.app.AlertController.C00304 */
                ...
                this.mListView.post(new Runnable() {
                    /* class androidx.appcompat.app.AlertController.RunnableC00315 */
        ...
        private void createListView(final AlertController dialog) {
            ...
            if (!this.mIsMultiChoice) {
                ...
                adapter = new ArrayAdapter<CharSequence>(this.mContext, dialog.mMultiChoiceItemLayout, 16908308, this.mItems) {
                    /* class androidx.appcompat.app.AlertController.AlertParams.C00321 */
                ...
                adapter = new CursorAdapter(this.mContext, this.mCursor, false) {
                    /* class androidx.appcompat.app.AlertController.AlertParams.C00332 */
            ...
            if (this.mOnClickListener != null) {
                listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                    /* class androidx.appcompat.app.AlertController.AlertParams.C00343 */
                ...
                listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                    /* class androidx.appcompat.app.AlertController.AlertParams.C00354 */

...
public class AppCompatDelegateImpl extends AppCompatDelegate implements MenuBuilder.Callback, LayoutInflater.Factory2 {
    ...
    static {
        ...
        if (z2 && !sInstalledExceptionHandler) {
            ...
            Thread.setDefaultUncaughtExceptionHandler(new Thread.UncaughtExceptionHandler() {
                /* class androidx.appcompat.app.AppCompatDelegateImpl.C00381 */
    ...
    private AppCompatDelegateImpl(Context context, Window window, AppCompatCallback callback, Object host) {
        ...
        this.mInvalidatePanelMenuRunnable = new Runnable() {
            /* class androidx.appcompat.app.AppCompatDelegateImpl.RunnableC00392 */
            ...
            if (subDecor != null) {
                if (Build.VERSION.SDK_INT >= 21) {
                    ViewCompat.setOnApplyWindowInsetsListener(subDecor, new OnApplyWindowInsetsListener() {
                        /* class androidx.appcompat.app.AppCompatDelegateImpl.C00403 */
                    ...
                    ((FitWindowsViewGroup) subDecor).setOnFitSystemWindowsListener(new FitWindowsViewGroup.OnFitSystemWindowsListener() {
                        /* class androidx.appcompat.app.AppCompatDelegateImpl.C00414 */
                ...
                contentView.setAttachListener(new ContentFrameLayout.OnAttachListener() {
                    /* class androidx.appcompat.app.AppCompatDelegateImpl.C00425 */
            ...
            if (this.mActionModeView == null) {
                if (this.mIsFloating) {
                    ...
                    this.mShowActionModePopup = new Runnable() {
                        /* class androidx.appcompat.app.AppCompatDelegateImpl.RunnableC00436 */
                        ...
                        public void run() {
                            ...
                            if (AppCompatDelegateImpl.this.shouldAnimateActionModeView()) {
                                ...
                                AppCompatDelegateImpl.this.mFadeAnim.setListener(new ViewPropertyAnimatorListenerAdapter() {
                                    /* class androidx.appcompat.app.AppCompatDelegateImpl.RunnableC00436.C00441 */
                ...
                if (callback.onCreateActionMode(mode2, mode2.getMenu())) {
                    ...
                    if (shouldAnimateActionModeView()) {
                        ...
                        alpha.setListener(new ViewPropertyAnimatorListenerAdapter() {
                            /* class androidx.appcompat.app.AppCompatDelegateImpl.C00457 */
    ...
    public View createView(View parent, String name, Context context, AttributeSet attrs) {
        ...
        if (this.mAppCompatViewInflater == null) {
            String viewInflaterClassName = this.mContext.obtainStyledAttributes(C0021R.styleable.AppCompatTheme).getString(C0021R.styleable.AppCompatTheme_viewInflaterClass);
    ...
    public class ActionModeCallbackWrapperV9 implements ActionMode.Callback {
        ...
        public void onDestroyActionMode(ActionMode mode) {
            ...
            if (AppCompatDelegateImpl.this.mActionModeView != null) {
                ...
                AppCompatDelegateImpl.this.mFadeAnim.setListener(new ViewPropertyAnimatorListenerAdapter() {
                    /* class androidx.appcompat.app.AppCompatDelegateImpl.ActionModeCallbackWrapperV9.C00461 */
    ...
    public static final class PanelFeatureState {
        ...
        public static class SavedState implements Parcelable {
            public static final Parcelable.Creator<SavedState> CREATOR = new Parcelable.ClassLoaderCreator<SavedState>() {
                /* class androidx.appcompat.app.AppCompatDelegateImpl.PanelFeatureState.SavedState.C00481 */
            ...
            if (filter != null && filter.countActions() != 0) {
                if (this.mReceiver == null) {
                    this.mReceiver = new BroadcastReceiver() {
                        /* class androidx.appcompat.app.AppCompatDelegateImpl.AutoNightModeManager.C00471 */

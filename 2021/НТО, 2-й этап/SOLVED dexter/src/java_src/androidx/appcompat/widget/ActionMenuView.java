...
public class ActionMenuView extends LinearLayoutCompat implements MenuBuilder.ItemInvoker, MenuView {
                ...
                if (!needsExpansion2) {
                    ...
                    while (i11 < childCount) {
                        ...
                        if (!lp5.expanded) {
                            ...
                            visibleItemCount = maxChildHeight2;
                            child4.measure(View.MeasureSpec.makeMeasureSpec((lp5.cellsUsed * cellSize) + lp5.extraPixels, BasicMeasure.EXACTLY), itemHeightSpec);
                        }
                        i11++;
    ...
    /* JADX INFO: Multiple debug info for r3v9 int: [D('dividerWidth' int), D('b' int)] */
    /* access modifiers changed from: protected */
    @Override // androidx.appcompat.widget.LinearLayoutCompat

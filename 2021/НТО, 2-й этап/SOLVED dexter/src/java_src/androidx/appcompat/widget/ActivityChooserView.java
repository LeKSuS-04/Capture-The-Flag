...
public class ActivityChooserView extends ViewGroup implements ActivityChooserModel.ActivityChooserModelClient {
    ...
    public ActivityChooserView(Context context, AttributeSet attrs, int defStyle) {
        ...
        this.mModelDataSetObserver = new DataSetObserver() {
            /* class androidx.appcompat.widget.ActivityChooserView.C00771 */
        ...
        this.mOnGlobalLayoutListener = new ViewTreeObserver.OnGlobalLayoutListener() {
            /* class androidx.appcompat.widget.ActivityChooserView.ViewTreeObserver$OnGlobalLayoutListenerC00782 */
        ...
        LayoutInflater.from(getContext()).inflate(C0021R.layout.abc_activity_chooser_view, (ViewGroup) this, true);
        ...
        expandButton.setAccessibilityDelegate(new View.AccessibilityDelegate() {
            /* class androidx.appcompat.widget.ActivityChooserView.C00793 */
        ...
        expandButton.setOnTouchListener(new ForwardingListener(expandButton) {
            /* class androidx.appcompat.widget.ActivityChooserView.C00804 */
        ...
        activityChooserViewAdapter.registerDataSetObserver(new DataSetObserver() {
            /* class androidx.appcompat.widget.ActivityChooserView.C00815 */
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            switch (getItemViewType(position)) {
                case 0:
                    ...
                    ((ImageView) convertView.findViewById(C0021R.C0024id.icon)).setImageDrawable(activity.loadIcon(packageManager));
                    ((TextView) convertView.findViewById(C0021R.C0024id.title)).setText(activity.loadLabel(packageManager));
                ...
                case 1:
                    ...
                    ((TextView) convertView2.findViewById(C0021R.C0024id.title)).setText(ActivityChooserView.this.getContext().getString(C0021R.string.abc_activity_chooser_view_see_all));
                    return convertView2;
                default:
                    throw new IllegalArgumentException();
            }

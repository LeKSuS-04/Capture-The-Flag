    ...
    public void measureVertical(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        while (i3 < count4) {
            ...
            if (child2 == null) {
                ...
                if (heightMode4 == 1073741824 && lp2.height == 0 && lp2.weight > 0.0f) {
                    ...
                    alternativeMaxWidth3 = measuredWidth;
                    childState3 = maxWidth;
                    measureChildBeforeLayout(child2, i, widthMeasureSpec, 0, heightMeasureSpec, i5);
        ...
        if (useLargestChild) {
            ...
            if (heightMode == Integer.MIN_VALUE || heightMode == 0) {
                ...
                int i7 = 0;
                while (i7 < count) {
                    View child3 = getVirtualChildAt(i7);
                    if (child3 == null) {
                        this.mTotalLength += measureNullChild(i7);
                        childState2 = maxWidth;
                    } else if (child3.getVisibility() == i6) {
                        i7 += getChildrenSkipCount(child3, i7);
                        childState2 = maxWidth;
                    } else {
                ...
                while (i8 < count) {
                    ...
                    if (child4 != null) {
                        ...
                        if (child4.getVisibility() == 8) {
                            ...
                            weightedMaxWidth = weightedMaxWidth6;
                            child4.measure(View.MeasureSpec.makeMeasureSpec(child4.getMeasuredWidth(), BasicMeasure.EXACTLY), View.MeasureSpec.makeMeasureSpec(largestChildHeight2, BasicMeasure.EXACTLY));
                        } else {
                            weightedMaxWidth = weightedMaxWidth6;
                        }
                    } else {
                            ...
                            switch (gravity2 & 112) {
                                ...
                                case 48:
                                    ...
                                    if (childBaseline == -1) {
                                        ...
                                        childTop = childTop2 + (maxAscent2[1] - childBaseline);
                                        break;
                                    }
                                case 80:
                                    childBottom = childBottom2;
                                    int childTop3 = (childBottom2 - childHeight) - lp.bottomMargin;
                                    if (childBaseline == -1) {
                                        childTop = childTop3;
                                        break;
                                    } else {

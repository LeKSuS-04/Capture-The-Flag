...
public class SearchView extends LinearLayoutCompat implements CollapsibleActionView {
    ...
    public SearchView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        this.mUpdateDrawableStateRunnable = new Runnable() {
            /* class androidx.appcompat.widget.SearchView.RunnableC00991 */
        ...
        this.mReleaseCursorRunnable = new Runnable() {
            /* class androidx.appcompat.widget.SearchView.RunnableC01012 */
        ...
        View$OnClickListenerC01045 r1 = new View.OnClickListener() {
            /* class androidx.appcompat.widget.SearchView.View$OnClickListenerC01045 */
        ...
        this.mTextKeyListener = new View.OnKeyListener() {
            /* class androidx.appcompat.widget.SearchView.View$OnKeyListenerC01056 */
        ...
        C01067 r2 = new TextView.OnEditorActionListener() {
            /* class androidx.appcompat.widget.SearchView.C01067 */
        ...
        C01078 r3 = new AdapterView.OnItemClickListener() {
            /* class androidx.appcompat.widget.SearchView.C01078 */
        ...
        C01089 r4 = new AdapterView.OnItemSelectedListener() {
            /* class androidx.appcompat.widget.SearchView.C01089 */
        ...
        this.mTextWatcher = new TextWatcher() {
            /* class androidx.appcompat.widget.SearchView.C010010 */
        ...
        LayoutInflater.from(context).inflate(a.getResourceId(C0021R.styleable.SearchView_layout, C0021R.layout.abc_search_view), (ViewGroup) this, true);
        ...
        searchAutoComplete.setOnFocusChangeListener(new View.OnFocusChangeListener() {
            /* class androidx.appcompat.widget.SearchView.View$OnFocusChangeListenerC01023 */
        ...
        setFocusable(a.getBoolean(C0021R.styleable.SearchView_android_focusable, true));
        a.recycle();
        ...
        if (findViewById3 != null) {
            findViewById3.addOnLayoutChangeListener(new View.OnLayoutChangeListener() {
                /* class androidx.appcompat.widget.SearchView.View$OnLayoutChangeListenerC01034 */
    ...
    public void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        switch (widthMode) {
            ...
            case 0:
                ...
                width = i2;
                break;
            case BasicMeasure.EXACTLY /*{ENCODED_INT: 1073741824}*/:
    ...
    public static class SavedState extends AbsSavedState {
        public static final Parcelable.Creator<SavedState> CREATOR = new Parcelable.ClassLoaderCreator<SavedState>() {
            /* class androidx.appcompat.widget.SearchView.SavedState.C01091 */
    ...
    public static class SearchAutoComplete extends AppCompatAutoCompleteTextView {
        ...
        public SearchAutoComplete(Context context, AttributeSet attrs, int defStyle) {
            ...
            this.mRunShowSoftInputIfNecessary = new Runnable() {
                /* class androidx.appcompat.widget.SearchView.SearchAutoComplete.RunnableC01101 */

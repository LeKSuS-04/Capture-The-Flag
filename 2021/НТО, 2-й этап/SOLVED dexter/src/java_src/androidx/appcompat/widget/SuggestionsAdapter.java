...
class SuggestionsAdapter extends ResourceCursorAdapter implements View.OnClickListener {
    ...
    public View newView(Context context, Cursor cursor, ViewGroup parent) {
        ...
        ((ImageView) v.findViewById(C0021R.C0024id.edit_query)).setImageResource(this.mCommitIconResId);
        return v;
    }
    ...
    public Cursor getSearchManagerSuggestions(SearchableInfo searchable, String query, int limit) {
        ...
        return this.mProviderContext.getContentResolver().query(uriBuilder.build(), null, selection, selArgs, null);
    }
}

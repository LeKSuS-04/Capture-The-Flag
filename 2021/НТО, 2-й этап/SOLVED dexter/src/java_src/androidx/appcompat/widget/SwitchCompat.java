...
public class SwitchCompat extends CompoundButton {
    ...
    private static final Property<SwitchCompat, Float> THUMB_POS = new Property<SwitchCompat, Float>(Float.class, "thumbPos") {
        /* class androidx.appcompat.widget.SwitchCompat.C01111 */
    ...
    public SwitchCompat(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        this.mTextOn = a.getText(C0021R.styleable.SwitchCompat_android_textOn);
        this.mTextOff = a.getText(C0021R.styleable.SwitchCompat_android_textOff);
    ...
    public void setSwitchTextAppearance(Context context, int resid) {
        ...
        setSwitchTypefaceByIndex(appearance.getInt(C0021R.styleable.TextAppearance_android_typeface, -1), appearance.getInt(C0021R.styleable.TextAppearance_android_textStyle, -1));
        if (appearance.getBoolean(C0021R.styleable.TextAppearance_textAllCaps, false)) {
    ...
    public void onLayout(boolean changed, int left, int top, int right, int bottom) {
        ...
        switch (getGravity() & 112) {
            case 16:
                ...
                int switchBottom = i + switchTop3;
                switchTop = switchTop3;
                switchTop2 = switchBottom;
                break;
            case 80:

...
public class CustomAttribute {
    ...
    public boolean isContinuous() {
        switch (C01331.f14xbc2a0812[this.mType.ordinal()]) {
            case 1:
            case 2:
            case 3:
                return false;
    ...
    public static void setAttributes(Object view, HashMap<String, CustomAttribute> map) {
        ...
        for (String name : map.keySet()) {
            ...
            try {
                switch (C01331.f14xbc2a0812[CustomAttribute.mType.ordinal()]) {
                    case 1:
                        cls.getMethod(methodName, Integer.TYPE).invoke(view, Integer.valueOf(CustomAttribute.mIntegerValue));
                        continue;
                    case 2:
                        cls.getMethod(methodName, Boolean.TYPE).invoke(view, Boolean.valueOf(CustomAttribute.mBooleanValue));
                        continue;
                    case 3:
                        cls.getMethod(methodName, CharSequence.class).invoke(view, CustomAttribute.mStringValue);
                        continue;
                    case 4:
                        cls.getMethod(methodName, Integer.TYPE).invoke(view, Integer.valueOf(CustomAttribute.mColorValue));
                        continue;
                    case 5:
                    default:
                        continue;
                    case 6:
                        ...
                        continue;
                    case 7:
                        cls.getMethod(methodName, Float.TYPE).invoke(view, Float.valueOf(CustomAttribute.mFloatValue));
                        continue;
                    case 8:
                        cls.getMethod(methodName, Float.TYPE).invoke(view, Float.valueOf(CustomAttribute.mFloatValue));
                        continue;

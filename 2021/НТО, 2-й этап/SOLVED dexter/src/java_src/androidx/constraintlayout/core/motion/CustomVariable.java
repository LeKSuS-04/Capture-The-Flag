...
public class CustomVariable {
    ...
    public String toString() {
        ...
        switch (this.mType) {
            case TypedValues.Custom.TYPE_INT /*{ENCODED_INT: 900}*/:
                return str + this.mIntegerValue;
            case TypedValues.Custom.TYPE_FLOAT /*{ENCODED_INT: 901}*/:
                return str + this.mFloatValue;
            case TypedValues.Custom.TYPE_COLOR /*{ENCODED_INT: 902}*/:
                return str + colorString(this.mIntegerValue);
            case TypedValues.Custom.TYPE_STRING /*{ENCODED_INT: 903}*/:
                return str + this.mStringValue;
            case TypedValues.Custom.TYPE_BOOLEAN /*{ENCODED_INT: 904}*/:
                return str + Boolean.valueOf(this.mBooleanValue);
            case TypedValues.Custom.TYPE_DIMENSION /*{ENCODED_INT: 905}*/:
                return str + this.mFloatValue;
            default:
                return str + "????";
        }
    ...
    public boolean isContinuous() {
        switch (this.mType) {
            case TypedValues.Custom.TYPE_STRING /*{ENCODED_INT: 903}*/:
            case TypedValues.Custom.TYPE_BOOLEAN /*{ENCODED_INT: 904}*/:
            case TypedValues.Custom.TYPE_REFERENCE /*{ENCODED_INT: 906}*/:
                return false;
            case TypedValues.Custom.TYPE_DIMENSION /*{ENCODED_INT: 905}*/:
            default:
                return true;

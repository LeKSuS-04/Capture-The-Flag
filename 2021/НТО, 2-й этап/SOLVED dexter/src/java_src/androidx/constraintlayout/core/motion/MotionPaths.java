...
public class MotionPaths implements Comparable<MotionPaths> {
    ...
    public void initCartesian(MotionKeyPosition c, MotionPaths startTimePoint, MotionPaths endTimePoint) {
        ...
        float position3 = startTimePoint.f19y;
        ...
        this.f18x = (float) ((int) ((f5 + (pathVectorX * position2)) - ((scaleX * scaleWidth) / 2.0f)));
        this.f19y = (float) ((int) ((position3 + (pathVectorY * position2)) - ((scaleY * scaleHeight) / 2.0f)));
        ...
        this.mMode = 0;
        this.f18x = (float) ((int) (((startTimePoint.f18x + (pathVectorX * dxdx)) + (pathVectorY * dxdy)) - ((scaleX * scaleWidth) / 2.0f)));
        this.f19y = (float) ((int) (((startTimePoint.f19y + (pathVectorX * dydx)) + (pathVectorY * dydy)) - ((scaleY * scaleHeight) / 2.0f)));
    ...
    public void initScreen(int parentWidth, int parentHeight, MotionKeyPosition c, MotionPaths startTimePoint, MotionPaths endTimePoint) {
        ...
        float endCenterX = endTimePoint.f18x + (f / 2.0f);
        float endCenterY = endTimePoint.f19y + (f3 / 2.0f);
        this.f18x = (float) ((int) ((f5 + ((endCenterX - (f5 + (f2 / 2.0f))) * position2)) - ((scaleX * scaleWidth) / 2.0f)));
        this.f19y = (float) ((int) ((position3 + ((endCenterY - (position3 + (f4 / 2.0f))) * position2)) - ((scaleY * scaleHeight) / 2.0f)));
        this.width = (float) ((int) (f2 + (scaleX * scaleWidth)));
        this.height = (float) ((int) (f4 + (scaleY * scaleHeight)));
        this.mMode = 2;
        if (!Float.isNaN(c.mPercentX)) {
            this.f18x = (float) ((int) (c.mPercentX * ((float) ((int) (((float) parentWidth) - this.width)))));
        }
        if (!Float.isNaN(c.mPercentY)) {
            this.f19y = (float) ((int) (c.mPercentY * ((float) ((int) (((float) parentHeight) - this.height)))));
        }
    ...
    public void initPath(MotionKeyPosition c, MotionPaths startTimePoint, MotionPaths endTimePoint) {
        ...
        float f = startTimePoint.f18x;
        float f2 = startTimePoint.width;
        float f3 = startTimePoint.f19y;
        float position3 = startTimePoint.height;
        float pathVectorX = (endTimePoint.f18x + (endTimePoint.width / 2.0f)) - ((f2 / 2.0f) + f);
        float pathVectorY = (endTimePoint.f19y + (endTimePoint.height / 2.0f)) - (f3 + (position3 / 2.0f));
        ...
        this.mMode = 1;
        float f4 = (float) ((int) ((startTimePoint.f18x + (pathVectorX * path)) - ((scaleX * scaleWidth) / 2.0f)));
        this.f18x = f4;
        float f5 = (float) ((int) ((startTimePoint.f19y + (pathVectorY * path)) - ((scaleY * scaleHeight) / 2.0f)));
        this.f19y = f5;
        this.f18x = f4 + ((-pathVectorY) * perpendicular);
    ...
    public void getCenter(double p, int[] toUse, double[] data, float[] point, int offset) {
        ...
        if (motion != null) {
            ...
            motion.getCenter(p, pos, new float[2]);
            float rx = pos[0];
            float ry = pos[1];
        ...
        while (true) {
            ...
            if (i2 < dArr.length) {
                ...
                if (motion != null) {
                    ...
                    float drx = vel[0];
                    float dry = vel[1];
                    float pos_x = (float) ((((double) rx) + (((double) v_x) * Math.sin((double) v_y3))) - ((double) (v_width3 / 2.0f)));
                    ...
                    if (!Float.isNaN(path_rotate2)) {
                        path_rotate = dpos_y;
                        motionWidget = view;
                        motionWidget.setRotationZ((float) (((double) path_rotate2) + Math.toDegrees(Math.atan2((double) dpos_y, (double) dpos_x))));
                    } else {
                        motionWidget = view;
                        path_rotate = dpos_y;
                    }
                    ...
                    v_height = v_height2;
                    if (!Float.isNaN(path_rotate2)) {
                        motionWidget.setRotationZ((float) (((double) 0.0f) + ((double) path_rotate2) + Math.toDegrees(Math.atan2((double) (dv_y + (dvalue / 2.0f)), (double) (dv_x + (dv_width / 2.0f))))));
                    }
                    v_y = v_y3;
                }
                int l = (int) (v_x + 0.5f);

...
public class MotionWidget implements TypedValues {
    ...
    public boolean setValueMotion(int id, int value) {
        switch (id) {
            case TypedValues.Motion.TYPE_ANIMATE_RELATIVE_TO /*{ENCODED_INT: 605}*/:
                this.motion.mAnimateRelativeTo = value;
                return true;
            case TypedValues.Motion.TYPE_ANIMATE_CIRCLEANGLE_TO /*{ENCODED_INT: 606}*/:
                this.motion.mAnimateCircleAngleTo = value;
                return true;
            case TypedValues.Motion.TYPE_PATHMOTION_ARC /*{ENCODED_INT: 607}*/:
                this.motion.mPathMotionArc = value;
                return true;
            case TypedValues.Motion.TYPE_DRAW_PATH /*{ENCODED_INT: 608}*/:
                this.motion.mDrawPath = value;
                return true;
            case TypedValues.Motion.TYPE_POLAR_RELATIVETO /*{ENCODED_INT: 609}*/:
                this.motion.mPolarRelativeTo = value;
                return true;
            case TypedValues.Motion.TYPE_QUANTIZE_MOTIONSTEPS /*{ENCODED_INT: 610}*/:
                this.motion.mQuantizeMotionSteps = value;
                return true;
            case TypedValues.Motion.TYPE_QUANTIZE_INTERPOLATOR_TYPE /*{ENCODED_INT: 611}*/:
                this.motion.mQuantizeInterpolatorType = value;
                return true;
            case TypedValues.Motion.TYPE_QUANTIZE_INTERPOLATOR_ID /*{ENCODED_INT: 612}*/:
    ...
    public boolean setValueMotion(int id, String value) {
        switch (id) {
            case TypedValues.Motion.TYPE_EASING /*{ENCODED_INT: 603}*/:
                this.motion.mTransitionEasing = value;
                return true;
            case TypedValues.Motion.TYPE_QUANTIZE_INTERPOLATOR /*{ENCODED_INT: 604}*/:
    ...
    public boolean setValueMotion(int id, float value) {
        switch (id) {
            case TypedValues.Motion.TYPE_STAGGER /*{ENCODED_INT: 600}*/:
                this.motion.mMotionStagger = value;
                return true;
            case TypedValues.Motion.TYPE_PATH_ROTATE /*{ENCODED_INT: 601}*/:
                this.motion.mPathRotate = value;
                return true;
            case TypedValues.Motion.TYPE_QUANTIZE_MOTION_PHASE /*{ENCODED_INT: 602}*/:

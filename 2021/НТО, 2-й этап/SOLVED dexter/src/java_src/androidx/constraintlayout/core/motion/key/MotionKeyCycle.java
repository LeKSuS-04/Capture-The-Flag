...
public class MotionKeyCycle extends MotionKey {
    ...
    public boolean setValue(int type, int value) {
        switch (type) {
            case TypedValues.Cycle.TYPE_CURVE_FIT /*{ENCODED_INT: 401}*/:
                this.mCurveFit = value;
                return true;
            case TypedValues.Cycle.TYPE_WAVE_SHAPE /*{ENCODED_INT: 421}*/:
    ...
    public boolean setValue(int type, String value) {
        switch (type) {
            case TypedValues.Cycle.TYPE_EASING /*{ENCODED_INT: 420}*/:
                this.mTransitionEasing = value;
                return true;
            case TypedValues.Cycle.TYPE_WAVE_SHAPE /*{ENCODED_INT: 421}*/:
            default:
                return super.setValue(type, value);
            case TypedValues.Cycle.TYPE_CUSTOM_WAVE_SHAPE /*{ENCODED_INT: 422}*/:
    ...
    public boolean setValue(int type, float value) {
        switch (type) {
            ...
            case 315:
                ...
                return true;
            case TypedValues.Cycle.TYPE_ALPHA /*{ENCODED_INT: 403}*/:
                this.mAlpha = value;
                return true;
            case TypedValues.Cycle.TYPE_PATH_ROTATE /*{ENCODED_INT: 416}*/:
                this.mTransitionPathRotate = value;
                return true;
            case TypedValues.Cycle.TYPE_WAVE_PERIOD /*{ENCODED_INT: 423}*/:
                this.mWavePeriod = value;
                return true;
            case TypedValues.Cycle.TYPE_WAVE_OFFSET /*{ENCODED_INT: 424}*/:
                this.mWaveOffset = value;
                return true;
            case TypedValues.Cycle.TYPE_WAVE_PHASE /*{ENCODED_INT: 425}*/:
    ...
    public void addCycleValues(HashMap<String, KeyCycleOscillator> oscSet) {
        ...
        for (String key : oscSet.keySet()) {
            if (key.startsWith("CUSTOM")) {
                ...
                if (!(cValue == null || cValue.getType() != 901 || (osc2 = oscSet.get(key)) == null)) {

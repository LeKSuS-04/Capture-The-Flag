...
public class MotionKeyPosition extends MotionKey {
    ...
    public boolean setValue(int type, int value) {
        switch (type) {
            case 100:
                ...
                return true;
            case TypedValues.Position.TYPE_CURVE_FIT /*{ENCODED_INT: 508}*/:
                this.mCurveFit = value;
                return true;
            case TypedValues.Position.TYPE_POSITION_TYPE /*{ENCODED_INT: 510}*/:
    ...
    public boolean setValue(int type, float value) {
        switch (type) {
            case TypedValues.Position.TYPE_PERCENT_WIDTH /*{ENCODED_INT: 503}*/:
                this.mPercentWidth = value;
                return true;
            case TypedValues.Position.TYPE_PERCENT_HEIGHT /*{ENCODED_INT: 504}*/:
                this.mPercentHeight = value;
                return true;
            case TypedValues.Position.TYPE_SIZE_PERCENT /*{ENCODED_INT: 505}*/:
                this.mPercentWidth = value;
                this.mPercentHeight = value;
                return true;
            case TypedValues.Position.TYPE_PERCENT_X /*{ENCODED_INT: 506}*/:
                this.mPercentX = value;
                return true;
            case TypedValues.Position.TYPE_PERCENT_Y /*{ENCODED_INT: 507}*/:
    ...
    public boolean setValue(int type, String value) {
        switch (type) {
            case TypedValues.Position.TYPE_TRANSITION_EASING /*{ENCODED_INT: 501}*/:

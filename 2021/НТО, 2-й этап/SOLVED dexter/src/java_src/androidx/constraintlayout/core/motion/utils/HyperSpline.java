...
public class HyperSpline {
    ...
    /* JADX INFO: Multiple debug info for r4v21 androidx.constraintlayout.core.motion.utils.HyperSpline$Cubic[]: [D('C' androidx.constraintlayout.core.motion.utils.HyperSpline$Cubic[]), D('i' int)] */

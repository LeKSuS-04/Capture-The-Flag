...
public class ConstraintReference implements Reference {
    ...
    public ConstraintReference margin(int value) {
        if (this.mLast != null) {
            switch (C01381.$SwitchMap$androidx$constraintlayout$core$state$State$Constraint[this.mLast.ordinal()]) {
                case 1:
                case 2:
    ...
    private void applyConnection(ConstraintWidget widget, Object opaqueTarget, State.Constraint type) {
        ...
        if (target != null) {
            int i = C01381.$SwitchMap$androidx$constraintlayout$core$state$State$Constraint[type.ordinal()];
            switch (C01381.$SwitchMap$androidx$constraintlayout$core$state$State$Constraint[type.ordinal()]) {
                case 1:
        ...
        if (this.mConstraintWidget != null) {
            ...
            if (hashMap != null) {
                for (String key2 : hashMap.keySet()) {
                    this.mConstraintWidget.frame.setCustomAttribute(key2, TypedValues.Custom.TYPE_COLOR, this.mCustomColors.get(key2).intValue());
                }
            }
            HashMap<String, Float> hashMap2 = this.mCustomFloats;
            if (hashMap2 != null) {
                for (String key3 : hashMap2.keySet()) {
                    this.mConstraintWidget.frame.setCustomAttribute(key3, TypedValues.Custom.TYPE_FLOAT, this.mCustomFloats.get(key3).floatValue());
                }
            }
        }
    }

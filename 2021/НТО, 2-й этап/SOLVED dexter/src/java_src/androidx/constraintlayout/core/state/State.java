...
public class State {
    ...
    public HelperReference helper(Object key, Helper type) {
        ...
        if (reference == null) {
            switch (C01391.$SwitchMap$androidx$constraintlayout$core$state$State$Helper[type.ordinal()]) {
                case 1:
    ...
    public static /* synthetic */ class C01391 {
    ...
    public void directMapping() {
        for (Object key : this.mReferences.keySet()) {
            ...
            if (ref instanceof ConstraintReference) {
                ((ConstraintReference) ref).setView(key);
            }
        }
    }
    ...
    public void map(Object key, Object view) {
        Reference ref = constraints(key);
        if (ref instanceof ConstraintReference) {
            ((ConstraintReference) ref).setView(view);
        }
    }
    ...
    public void setTag(String key, String tag) {
        ...
        Reference ref = constraints(key);
        if (ref instanceof ConstraintReference) {
            ((ConstraintReference) ref).setTag(tag);
    ...
    public void apply(ConstraintWidgetContainer container) {
        ...
        for (Object key6 : this.mReferences.keySet()) {
            ...
            if (widget2 != null && (key6 instanceof String)) {
                widget2.stringId = (String) key6;
            }
        }
    }
}

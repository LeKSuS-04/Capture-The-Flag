...
public class Grouping {
    ...
    public static boolean simpleSolvingPass(ConstraintWidgetContainer layout, BasicMeasure.Measurer measurer) {
        ...
        if (verticalGuidelines != null) {
            ...
            while (it.hasNext()) {
                findDependents(it.next(), 0, allDependencyLists, null);
            }
        }
        if (horizontalBarriers != null) {
        ...
        if (left.getDependents() != null) {
            ...
            while (it3.hasNext()) {
                findDependents(it3.next().mOwner, 0, allDependencyLists, null);
                left = left;
            }
        }
        ...
        if (right.getDependents() != null) {
            ...
            while (it4.hasNext()) {
                findDependents(it4.next().mOwner, 0, allDependencyLists, null);
                right = right;
            }
        }
        ...
        if (center.getDependents() != null) {
            ...
            while (it5.hasNext()) {
                findDependents(it5.next().mOwner, 0, allDependencyLists, null);
                center = center;
            }
        }
        if (isolatedHorizontalChildren != null) {
            ...
            while (it6.hasNext()) {
                findDependents(it6.next(), 0, allDependencyLists, null);
            }
        }
        if (horizontalGuidelines != null) {
            Iterator<Guideline> it7 = horizontalGuidelines.iterator();
            while (it7.hasNext()) {
                findDependents(it7.next(), 1, allDependencyLists, null);
            }
        }
        if (verticalBarriers != null) {
        ...
        if (top.getDependents() != null) {
            ...
            while (it9.hasNext()) {
                findDependents(it9.next().mOwner, 1, allDependencyLists, null);
        ...
        if (baseline.getDependents() != null) {
            ...
            while (it10.hasNext()) {
                findDependents(it10.next().mOwner, 1, allDependencyLists, null);
                baseline = baseline;
            }
        }
        ...
        if (bottom.getDependents() != null) {
            ...
            while (it11.hasNext()) {
                findDependents(it11.next().mOwner, 1, allDependencyLists, null);
                bottom = bottom;
            }
        }
        ...
        if (center2.getDependents() != null) {
            ...
            while (it12.hasNext()) {
                findDependents(it12.next().mOwner, 1, allDependencyLists, null);
                center2 = center2;
            }
        }
        if (isolatedVerticalChildren != null) {
            ...
            while (it13.hasNext()) {
                findDependents(it13.next(), 1, allDependencyLists, null);
            }
        }

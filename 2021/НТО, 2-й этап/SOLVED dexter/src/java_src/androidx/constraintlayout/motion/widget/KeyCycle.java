...
public class KeyCycle extends Key {
    ...
    public void load(Context context, AttributeSet attrs) {
        Loader.read(this, context.obtainStyledAttributes(attrs, C0172R.styleable.KeyCycle));
    }
    ...
    public void addCycleValues(HashMap<String, ViewOscillator> oscSet) {
        ...
        for (String key : oscSet.keySet()) {
            if (key.startsWith("CUSTOM")) {
                ...
                if (!(cValue == null || cValue.getType() != ConstraintAttribute.AttributeType.FLOAT_TYPE || (osc2 = oscSet.get(key)) == null)) {
                ...
                if (!Float.isNaN(value) && (osc = oscSet.get(key)) != null) {
    ...
    private static class Loader {
        ...
        static {
            ...
            sparseIntArray.append(C0172R.styleable.KeyCycle_motionTarget, 1);
            mAttrMap.append(C0172R.styleable.KeyCycle_framePosition, 2);
            mAttrMap.append(C0172R.styleable.KeyCycle_transitionEasing, 3);
            mAttrMap.append(C0172R.styleable.KeyCycle_curveFit, 4);
            mAttrMap.append(C0172R.styleable.KeyCycle_waveShape, 5);
            mAttrMap.append(C0172R.styleable.KeyCycle_wavePeriod, 6);
            mAttrMap.append(C0172R.styleable.KeyCycle_waveOffset, 7);
            mAttrMap.append(C0172R.styleable.KeyCycle_waveVariesBy, 8);
            mAttrMap.append(C0172R.styleable.KeyCycle_android_alpha, 9);
            mAttrMap.append(C0172R.styleable.KeyCycle_android_elevation, 10);
            mAttrMap.append(C0172R.styleable.KeyCycle_android_rotation, 11);
            mAttrMap.append(C0172R.styleable.KeyCycle_android_rotationX, 12);
            mAttrMap.append(C0172R.styleable.KeyCycle_android_rotationY, 13);
            mAttrMap.append(C0172R.styleable.KeyCycle_transitionPathRotate, 14);
            mAttrMap.append(C0172R.styleable.KeyCycle_android_scaleX, 15);
            mAttrMap.append(C0172R.styleable.KeyCycle_android_scaleY, 16);
            mAttrMap.append(C0172R.styleable.KeyCycle_android_translationX, 17);
            mAttrMap.append(C0172R.styleable.KeyCycle_android_translationY, 18);
            mAttrMap.append(C0172R.styleable.KeyCycle_android_translationZ, 19);
            mAttrMap.append(C0172R.styleable.KeyCycle_motionProgress, 20);
            mAttrMap.append(C0172R.styleable.KeyCycle_wavePhase, 21);
        }

...
public class ImageFilterButton extends AppCompatImageButton {
        ...
        if (round != 0.0f) {
            ...
            if (Build.VERSION.SDK_INT >= 21) {
                if (this.mViewOutlineProvider == null) {
                    C01621 r2 = new ViewOutlineProvider() {
                        /* class androidx.constraintlayout.utils.widget.ImageFilterButton.C01621 */
    ...
    public void setRound(float round) {
        ...
        if (round != 0.0f) {
            ...
            if (Build.VERSION.SDK_INT >= 21) {
                if (this.mViewOutlineProvider == null) {
                    C01632 r2 = new ViewOutlineProvider() {
                        /* class androidx.constraintlayout.utils.widget.ImageFilterButton.C01632 */

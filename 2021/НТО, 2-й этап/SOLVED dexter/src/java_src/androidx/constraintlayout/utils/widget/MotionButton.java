...
public class MotionButton extends AppCompatButton {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            for (int i = 0; i < N; i++) {
                ...
                if (attr == C0172R.styleable.ImageFilterView_round) {
                    if (Build.VERSION.SDK_INT >= 21) {
                        setRound(a.getDimension(attr, 0.0f));
                    }
                } else if (attr == C0172R.styleable.ImageFilterView_roundPercent && Build.VERSION.SDK_INT >= 21) {
        ...
        if (round != 0.0f) {
            ...
            if (Build.VERSION.SDK_INT >= 21) {
                if (this.mViewOutlineProvider == null) {
                    C01661 r2 = new ViewOutlineProvider() {
                        /* class androidx.constraintlayout.utils.widget.MotionButton.C01661 */
    ...
    public void setRound(float round) {
        ...
        if (round != 0.0f) {
            ...
            if (Build.VERSION.SDK_INT >= 21) {
                if (this.mViewOutlineProvider == null) {
                    C01672 r2 = new ViewOutlineProvider() {
                        /* class androidx.constraintlayout.utils.widget.MotionButton.C01672 */

        ...
        if (Build.VERSION.SDK_INT >= 28) {
            ...
            try {
                ...
                handler.post(new Runnable() {
                    /* class androidx.core.app.ActivityRecreator.RunnableC01901 */
                ...
                try {
                    ...
                    handler.post(new Runnable() {
                        /* class androidx.core.app.ActivityRecreator.RunnableC01912 */
            ...
            if (token == currentlyRecreatingToken) {
                if (activity.hashCode() == currentlyRecreatingHashCode) {
                    ...
                    mainHandler.postAtFrontOfQueue(new Runnable() {
                        /* class androidx.core.app.ActivityRecreator.RunnableC01923 */

...
public class NotificationCompat {
    ...
    public static class Builder {
        ...
        private Bitmap reduceLargeIconSize(Bitmap icon) {
            ...
            int maxWidth = res.getDimensionPixelSize(C0183R.dimen.compat_notification_large_icon_max_width);
            int maxHeight = res.getDimensionPixelSize(C0183R.dimen.compat_notification_large_icon_max_height);
    ...
    public static abstract class Style {
        ...
        public RemoteViews applyStandardTemplate(boolean showSmallIcon, int resId, boolean fitIn1U) {
            ...
            if (Build.VERSION.SDK_INT >= 16 && Build.VERSION.SDK_INT < 21) {
                if (minPriority) {
                    contentView.setInt(C0183R.C0186id.notification_background, "setBackgroundResource", C0183R.C0185drawable.notification_bg_low);
                    contentView.setInt(C0183R.C0186id.icon, "setBackgroundResource", C0183R.C0185drawable.notification_template_icon_low_bg);
                } else {
                    contentView.setInt(C0183R.C0186id.notification_background, "setBackgroundResource", C0183R.C0185drawable.notification_bg);
                    contentView.setInt(C0183R.C0186id.icon, "setBackgroundResource", C0183R.C0185drawable.notification_template_icon_bg);
                }
            }
            if (this.mBuilder.mLargeIcon != null) {
                if (Build.VERSION.SDK_INT >= 16) {
                    contentView.setViewVisibility(C0183R.C0186id.icon, 0);
                    contentView.setImageViewBitmap(C0183R.C0186id.icon, this.mBuilder.mLargeIcon);
                } else {
                    contentView.setViewVisibility(C0183R.C0186id.icon, 8);
                }
                if (showSmallIcon && this.mBuilder.mNotification.icon != 0) {
                    int backgroundSize = res.getDimensionPixelSize(C0183R.dimen.notification_right_icon_size);
                    int iconSize = backgroundSize - (res.getDimensionPixelSize(C0183R.dimen.notification_small_icon_background_padding) * 2);
                    if (Build.VERSION.SDK_INT >= 21) {
                        contentView.setImageViewBitmap(C0183R.C0186id.right_icon, createIconWithBackground(this.mBuilder.mNotification.icon, backgroundSize, iconSize, this.mBuilder.getColor()));
                    } else {
                        contentView.setImageViewBitmap(C0183R.C0186id.right_icon, createColoredBitmap(this.mBuilder.mNotification.icon, -1));
                    }
                    contentView.setViewVisibility(C0183R.C0186id.right_icon, 0);
                }
            } else if (showSmallIcon && this.mBuilder.mNotification.icon != 0) {
                contentView.setViewVisibility(C0183R.C0186id.icon, 0);
                if (Build.VERSION.SDK_INT >= 21) {
                    contentView.setImageViewBitmap(C0183R.C0186id.icon, createIconWithBackground(this.mBuilder.mNotification.icon, res.getDimensionPixelSize(C0183R.dimen.notification_large_icon_width) - res.getDimensionPixelSize(C0183R.dimen.notification_big_circle_margin), res.getDimensionPixelSize(C0183R.dimen.notification_small_icon_size_as_large), this.mBuilder.getColor()));
                } else {
                    contentView.setImageViewBitmap(C0183R.C0186id.icon, createColoredBitmap(this.mBuilder.mNotification.icon, -1));
                }
            }
            if (this.mBuilder.mContentTitle != null) {
                contentView.setTextViewText(C0183R.C0186id.title, this.mBuilder.mContentTitle);
            }
            if (this.mBuilder.mContentText != null) {
                contentView.setTextViewText(C0183R.C0186id.text, this.mBuilder.mContentText);
                showLine3 = true;
            }
            boolean hasRightSide2 = Build.VERSION.SDK_INT < 21 && this.mBuilder.mLargeIcon != null;
            if (this.mBuilder.mContentInfo != null) {
                contentView.setTextViewText(C0183R.C0186id.info, this.mBuilder.mContentInfo);
                contentView.setViewVisibility(C0183R.C0186id.info, 0);
                showLine3 = true;
                hasRightSide = true;
            } else if (this.mBuilder.mNumber > 0) {
                if (this.mBuilder.mNumber > res.getInteger(C0183R.integer.status_bar_notification_info_maxnum)) {
                    contentView.setTextViewText(C0183R.C0186id.info, res.getString(C0183R.string.status_bar_notification_info_overflow));
                } else {
                    contentView.setTextViewText(C0183R.C0186id.info, NumberFormat.getIntegerInstance().format((long) this.mBuilder.mNumber));
                }
                contentView.setViewVisibility(C0183R.C0186id.info, 0);
                showLine3 = true;
                hasRightSide = true;
            } else {
                contentView.setViewVisibility(C0183R.C0186id.info, 8);
                hasRightSide = hasRightSide2;
            }
            if (this.mBuilder.mSubText != null && Build.VERSION.SDK_INT >= 16) {
                contentView.setTextViewText(C0183R.C0186id.text, this.mBuilder.mSubText);
                if (this.mBuilder.mContentText != null) {
                    contentView.setTextViewText(C0183R.C0186id.text2, this.mBuilder.mContentText);
                    contentView.setViewVisibility(C0183R.C0186id.text2, 0);
                    showLine2 = true;
                    if (showLine2 && Build.VERSION.SDK_INT >= 16) {
                        if (fitIn1U) {
                            contentView.setTextViewTextSize(C0183R.C0186id.text, 0, (float) res.getDimensionPixelSize(C0183R.dimen.notification_subtext_size));
                        }
                        contentView.setViewPadding(C0183R.C0186id.line1, 0, 0, 0, 0);
                    }
                    if (this.mBuilder.getWhenIfShowing() != 0) {
                        if (!this.mBuilder.mUseChronometer || Build.VERSION.SDK_INT < 16) {
                            contentView.setViewVisibility(C0183R.C0186id.time, 0);
                            contentView.setLong(C0183R.C0186id.time, "setTime", this.mBuilder.getWhenIfShowing());
                        } else {
                            contentView.setViewVisibility(C0183R.C0186id.chronometer, 0);
                            contentView.setLong(C0183R.C0186id.chronometer, "setBase", this.mBuilder.getWhenIfShowing() + (SystemClock.elapsedRealtime() - System.currentTimeMillis()));
                            contentView.setBoolean(C0183R.C0186id.chronometer, "setStarted", true);
                            if (this.mBuilder.mChronometerCountDown && Build.VERSION.SDK_INT >= 24) {
                                contentView.setChronometerCountDown(C0183R.C0186id.chronometer, this.mBuilder.mChronometerCountDown);
                            }
                        }
                        hasRightSide = true;
                    }
                    contentView.setViewVisibility(C0183R.C0186id.right_side, !hasRightSide ? 0 : 8);
                    int i2 = C0183R.C0186id.line3;
                    if (!showLine3) {
                        i = 8;
                    }
                ...
                contentView.setViewVisibility(C0183R.C0186id.text2, 8);
            }
            showLine2 = false;
            if (fitIn1U) {
            }
        ...
        private Bitmap createIconWithBackground(int iconId, int size, int iconSize, int color) {
            Bitmap coloredBitmap = createColoredBitmap(C0183R.C0185drawable.notification_icon_background, color == 0 ? 0 : color, size);
        ...
        public void buildIntoRemoteViews(RemoteViews outerView, RemoteViews innerView) {
            ...
            outerView.removeAllViews(C0183R.C0186id.notification_main_column);
            outerView.addView(C0183R.C0186id.notification_main_column, innerView.clone());
            outerView.setViewVisibility(C0183R.C0186id.notification_main_column, 0);
            if (Build.VERSION.SDK_INT >= 21) {
                outerView.setViewPadding(C0183R.C0186id.notification_main_column_container, 0, calculateTopPadding(), 0, 0);
            }
        }

        private void hideNormalContent(RemoteViews outerView) {
            outerView.setViewVisibility(C0183R.C0186id.title, 8);
            outerView.setViewVisibility(C0183R.C0186id.text2, 8);
            outerView.setViewVisibility(C0183R.C0186id.text, 8);
        }

        private int calculateTopPadding() {
            Resources resources = this.mBuilder.mContext.getResources();
            int padding = resources.getDimensionPixelSize(C0183R.dimen.notification_top_pad);
            int largePadding = resources.getDimensionPixelSize(C0183R.dimen.notification_top_pad_large_text);
    ...
    public static class DecoratedCustomViewStyle extends Style {
        ...
        private RemoteViews createRemoteViews(RemoteViews innerView, boolean showActions) {
            ...
            RemoteViews remoteViews = applyStandardTemplate(true, C0183R.layout.notification_template_custom_big, false);
            remoteViews.removeAllViews(C0183R.C0186id.actions);
            ...
            if (showActions && nonContextualActions != null && (numActions = Math.min(nonContextualActions.size(), 3)) > 0) {
                ...
                for (int i = 0; i < numActions; i++) {
                    remoteViews.addView(C0183R.C0186id.actions, generateActionButton(nonContextualActions.get(i)));
                }
            }
            if (!actionsVisible) {
                actionVisibility = 8;
            }
            remoteViews.setViewVisibility(C0183R.C0186id.actions, actionVisibility);
            remoteViews.setViewVisibility(C0183R.C0186id.action_divider, actionVisibility);
        ...
        private RemoteViews generateActionButton(Action action) {
            ...
            if (tombstone) {
                i = C0183R.layout.notification_action_tombstone;
            } else {
                i = C0183R.layout.notification_action;
            }
            RemoteViews button = new RemoteViews(packageName, i);
            IconCompat icon = action.getIconCompat();
            if (icon != null) {
                button.setImageViewBitmap(C0183R.C0186id.action_image, createColoredBitmap(icon, this.mBuilder.mContext.getResources().getColor(C0183R.C0184color.notification_action_color_filter)));
            }
            button.setTextViewText(C0183R.C0186id.action_text, action.title);
            if (!tombstone) {
                button.setOnClickPendingIntent(C0183R.C0186id.action_container, action.actionIntent);
            }
            if (Build.VERSION.SDK_INT >= 15) {
                button.setContentDescription(C0183R.C0186id.action_container, action.title);
            }
            return button;
        }
    }
    ...
    public static class Action {
        ...
        public Action(int icon2, CharSequence title2, PendingIntent intent) {
            this(icon2 != 0 ? IconCompat.createWithResource(null, "", icon2) : null, title2, intent);
        }
        ...
        Action(int icon2, CharSequence title2, PendingIntent intent, Bundle extras, RemoteInput[] remoteInputs, RemoteInput[] dataOnlyRemoteInputs, boolean allowGeneratedReplies, int semanticAction, boolean showsUserInterface, boolean isContextual) {
            this(icon2 != 0 ? IconCompat.createWithResource(null, "", icon2) : null, title2, intent, extras, remoteInputs, dataOnlyRemoteInputs, allowGeneratedReplies, semanticAction, showsUserInterface, isContextual);
        }

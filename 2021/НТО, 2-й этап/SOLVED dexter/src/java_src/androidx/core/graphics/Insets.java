...
public final class Insets {
    ...
    public static Insets add(Insets a, Insets b) {
        return m5of(a.left + b.left, a.top + b.top, a.right + b.right, a.bottom + b.bottom);
    }
    ...
    public static Insets max(Insets a, Insets b) {
        return m5of(Math.max(a.left, b.left), Math.max(a.top, b.top), Math.max(a.right, b.right), Math.max(a.bottom, b.bottom));
    }

    public static Insets min(Insets a, Insets b) {
        return m5of(Math.min(a.left, b.left), Math.min(a.top, b.top), Math.min(a.right, b.right), Math.min(a.bottom, b.bottom));
    }

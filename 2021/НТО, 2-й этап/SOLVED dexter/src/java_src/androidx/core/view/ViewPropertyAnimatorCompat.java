...
public final class ViewPropertyAnimatorCompat {
    ...
    /* renamed from: x */
    public ViewPropertyAnimatorCompat mo6225x(float value) {
        View view = this.mView.get();
        if (view != null) {
    ...
    /* renamed from: y */
    public ViewPropertyAnimatorCompat mo6227y(float value) {
        View view = this.mView.get();
        if (view != null) {
    ...
    /* renamed from: z */
    public ViewPropertyAnimatorCompat mo6229z(float value) {
        View view = this.mView.get();
        if (view != null && Build.VERSION.SDK_INT >= 21) {
    ...
    private void setListenerInternal(final View view, final ViewPropertyAnimatorListener listener) {
        if (listener != null) {
            view.animate().setListener(new AnimatorListenerAdapter() {
                /* class androidx.core.view.ViewPropertyAnimatorCompat.C02341 */
        ...
        if (view != null && Build.VERSION.SDK_INT >= 19) {
            ...
            if (listener != null) {
                wrapped = new ValueAnimator.AnimatorUpdateListener() {
                    /* class androidx.core.view.ViewPropertyAnimatorCompat.C02352 */

                ...
                case 8:
                    ...
                    if (view != null && view.hasWindowFocus()) {
                        view.post(new Runnable() {
                            /* class androidx.core.view.WindowInsetsControllerCompat.Impl20.RunnableC02391 */
    ...
    private static class Impl30 extends Impl {
        ...
        public void controlWindowInsetsAnimation(int types, long durationMillis, Interpolator interpolator, CancellationSignal cancellationSignal, final WindowInsetsAnimationControlListenerCompat listener) {
            this.mInsetsController.controlWindowInsetsAnimation(types, durationMillis, interpolator, cancellationSignal, new WindowInsetsAnimationControlListener() {
                /* class androidx.core.view.WindowInsetsControllerCompat.Impl30.WindowInsetsAnimationControlListenerC02401 */
        ...
        public void addOnControllableInsetsChangedListener(final OnControllableInsetsChangedListener listener) {
            if (!this.mListeners.containsKey(listener)) {
                WindowInsetsController.OnControllableInsetsChangedListener fwListener = new WindowInsetsController.OnControllableInsetsChangedListener() {
                    /* class androidx.core.view.WindowInsetsControllerCompat.Impl30.WindowInsetsController$OnControllableInsetsChangedListenerC02412 */

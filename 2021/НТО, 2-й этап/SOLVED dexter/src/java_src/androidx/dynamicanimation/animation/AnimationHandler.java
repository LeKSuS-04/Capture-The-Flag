...
public class AnimationHandler {
    ...
    public static class FrameCallbackProvider16 extends AnimationFrameCallbackProvider {
        ...
        private final Choreographer.FrameCallback mChoreographerCallback = new Choreographer.FrameCallback() {
            /* class androidx.dynamicanimation.animation.AnimationHandler.FrameCallbackProvider16.Choreographer$FrameCallbackC02711 */
    ...
    public static class FrameCallbackProvider14 extends AnimationFrameCallbackProvider {
        ...
        private final Runnable mRunnable = new Runnable() {
            /* class androidx.dynamicanimation.animation.AnimationHandler.FrameCallbackProvider14.RunnableC02701 */

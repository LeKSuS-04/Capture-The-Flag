...
public abstract class DynamicAnimation<T extends DynamicAnimation<T>> implements AnimationHandler.AnimationFrameCallback {
    public static final ViewProperty ALPHA = new ViewProperty("alpha") {
        /* class androidx.dynamicanimation.animation.DynamicAnimation.C027512 */
    ...
    public static final ViewProperty ROTATION = new ViewProperty(Key.ROTATION) {
        /* class androidx.dynamicanimation.animation.DynamicAnimation.C02836 */
    ...
    public static final ViewProperty ROTATION_X = new ViewProperty("rotationX") {
        /* class androidx.dynamicanimation.animation.DynamicAnimation.C02847 */
    ...
    public static final ViewProperty ROTATION_Y = new ViewProperty("rotationY") {
        /* class androidx.dynamicanimation.animation.DynamicAnimation.C02858 */
    ...
    public static final ViewProperty SCALE_X = new ViewProperty("scaleX") {
        /* class androidx.dynamicanimation.animation.DynamicAnimation.C02814 */
    ...
    public static final ViewProperty SCALE_Y = new ViewProperty("scaleY") {
        /* class androidx.dynamicanimation.animation.DynamicAnimation.C02825 */
    ...
    public static final ViewProperty SCROLL_X = new ViewProperty("scrollX") {
        /* class androidx.dynamicanimation.animation.DynamicAnimation.C027613 */
    ...
    public static final ViewProperty SCROLL_Y = new ViewProperty("scrollY") {
        /* class androidx.dynamicanimation.animation.DynamicAnimation.C027714 */
    ...
    public static final ViewProperty TRANSLATION_X = new ViewProperty("translationX") {
        /* class androidx.dynamicanimation.animation.DynamicAnimation.C02721 */
    ...
    public static final ViewProperty TRANSLATION_Y = new ViewProperty("translationY") {
        /* class androidx.dynamicanimation.animation.DynamicAnimation.C02792 */
    ...
    public static final ViewProperty TRANSLATION_Z = new ViewProperty("translationZ") {
        /* class androidx.dynamicanimation.animation.DynamicAnimation.C02803 */
    ...
    public static final ViewProperty f71X = new ViewProperty("x") {
        /* class androidx.dynamicanimation.animation.DynamicAnimation.C02869 */
    ...
    public static final ViewProperty f72Y = new ViewProperty("y") {
        /* class androidx.dynamicanimation.animation.DynamicAnimation.C027310 */
    ...
    public static final ViewProperty f73Z = new ViewProperty("z") {
        /* class androidx.dynamicanimation.animation.DynamicAnimation.C027411 */
    ...
    DynamicAnimation(final FloatValueHolder floatValueHolder) {
        ...
        this.mProperty = new FloatPropertyCompat("FloatValueHolder") {
            /* class androidx.dynamicanimation.animation.DynamicAnimation.C027815 */

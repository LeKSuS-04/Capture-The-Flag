...
public class DialogFragment extends Fragment implements DialogInterface.OnCancelListener, DialogInterface.OnDismissListener {
    ...
    private Runnable mDismissRunnable = new Runnable() {
        /* class androidx.fragment.app.DialogFragment.RunnableC03041 */
    ...
    private Observer<LifecycleOwner> mObserver = new Observer<LifecycleOwner>() {
        /* class androidx.fragment.app.DialogFragment.C03074 */
    ...
    private DialogInterface.OnCancelListener mOnCancelListener = new DialogInterface.OnCancelListener() {
        /* class androidx.fragment.app.DialogFragment.DialogInterface$OnCancelListenerC03052 */
    ...
    private DialogInterface.OnDismissListener mOnDismissListener = new DialogInterface.OnDismissListener() {
        /* class androidx.fragment.app.DialogFragment.DialogInterface$OnDismissListenerC03063 */
    ...
    public FragmentContainer createFragmentContainer() {
        ...
        return new FragmentContainer() {
            /* class androidx.fragment.app.DialogFragment.C03085 */

...
public class Fragment implements ComponentCallbacks, View.OnCreateContextMenuListener, LifecycleOwner, ViewModelStoreOwner, HasDefaultViewModelProviderFactory, SavedStateRegistryOwner, ActivityResultCaller {
    ...
    public static class SavedState implements Parcelable {
        public static final Parcelable.Creator<SavedState> CREATOR = new Parcelable.ClassLoaderCreator<SavedState>() {
            /* class androidx.fragment.app.Fragment.SavedState.C03181 */
    ...
    public Fragment() {
        ...
        this.mPostponedDurationRunnable = new Runnable() {
            /* class androidx.fragment.app.Fragment.RunnableC03091 */
        ...
        if (this.mAnimationInfo != null && ensureAnimationInfo().mEnterTransitionPostponed) {
            if (this.mHost == null) {
                ...
                this.mHost.getHandler().postAtFrontOfQueue(new Runnable() {
                    /* class androidx.fragment.app.Fragment.RunnableC03102 */
        ...
        if (listener != null) {
            ...
            if (calledDirectly) {
                this.mHost.getHandler().post(new Runnable() {
                    /* class androidx.fragment.app.Fragment.RunnableC03113 */
    ...
    public FragmentContainer createFragmentContainer() {
        return new FragmentContainer() {
            /* class androidx.fragment.app.Fragment.C03124 */
    ...
    public void performCreate(Bundle savedInstanceState) {
        ...
        if (Build.VERSION.SDK_INT >= 19) {
            this.mLifecycleRegistry.addObserver(new LifecycleEventObserver() {
                /* class androidx.fragment.app.Fragment.C03135 */
    ...
    public final <I, O> ActivityResultLauncher<I> registerForActivityResult(ActivityResultContract<I, O> contract, ActivityResultCallback<O> callback) {
        return prepareCallInternal(contract, new Function<Void, ActivityResultRegistry>() {
            /* class androidx.fragment.app.Fragment.C03146 */
    ...
    public final <I, O> ActivityResultLauncher<I> registerForActivityResult(ActivityResultContract<I, O> contract, final ActivityResultRegistry registry, ActivityResultCallback<O> callback) {
        return prepareCallInternal(contract, new Function<Void, ActivityResultRegistry>() {
            /* class androidx.fragment.app.Fragment.C03157 */
    ...
    private <I, O> ActivityResultLauncher<I> prepareCallInternal(final ActivityResultContract<I, O> contract, final Function<Void, ActivityResultRegistry> registryProvider, final ActivityResultCallback<O> callback) {
        if (this.mState <= 1) {
            ...
            registerOnPreAttachListener(new OnPreAttachedListener() {
                /* class androidx.fragment.app.Fragment.C03168 */

                /* access modifiers changed from: package-private */
                @Override // androidx.fragment.app.Fragment.OnPreAttachedListener
                public void onPreAttached() {
                    ref.set(((ActivityResultRegistry) registryProvider.apply(null)).register(Fragment.this.generateActivityResultKey(), Fragment.this, contract, callback));
                }
            });
            return new ActivityResultLauncher<I>() {
                /* class androidx.fragment.app.Fragment.C03179 */

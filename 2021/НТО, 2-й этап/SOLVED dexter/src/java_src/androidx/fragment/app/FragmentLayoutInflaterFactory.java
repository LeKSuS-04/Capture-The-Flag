...
public class FragmentLayoutInflaterFactory implements LayoutInflater.Factory2 {
    ...
    public View onCreateView(View parent, String name, Context context, AttributeSet attrs) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, C0288R.styleable.Fragment);
        if (fname == null) {
            fname = a.getString(C0288R.styleable.Fragment_android_name);
        }
        int id = a.getResourceId(C0288R.styleable.Fragment_android_id, -1);
        String tag = a.getString(C0288R.styleable.Fragment_android_tag);
        a.recycle();
        ...
        if (fragment.mView != null) {
            ...
            fragment.mView.addOnAttachStateChangeListener(new View.OnAttachStateChangeListener() {
                /* class androidx.fragment.app.FragmentLayoutInflaterFactory.View$OnAttachStateChangeListenerC03251 */

...
public abstract class SpecialEffectsController {
    ...
    static SpecialEffectsController getOrCreateController(ViewGroup container, SpecialEffectsControllerFactory factory) {
        Object controller = container.getTag(C0288R.C0291id.special_effects_controller_view_tag);
        ...
        container.setTag(C0288R.C0291id.special_effects_controller_view_tag, newController);
    ...
    private void enqueue(Operation.State finalState, Operation.LifecycleImpact lifecycleImpact, FragmentStateManager fragmentStateManager) {
        synchronized (this.mPendingOperations) {
            ...
            operation.addCompletionListener(new Runnable() {
                /* class androidx.fragment.app.SpecialEffectsController.RunnableC03611 */
            ...
            operation.addCompletionListener(new Runnable() {
                /* class androidx.fragment.app.SpecialEffectsController.RunnableC03622 */
    ...
    public static class Operation {
        ...
        public enum State {
            ...
            public void applyState(View view) {
                switch (C03633.f76xe493b431[ordinal()]) {
                    case 1:
        ...
        Operation(State finalState, LifecycleImpact lifecycleImpact, Fragment fragment, CancellationSignal cancellationSignal) {
            ...
            cancellationSignal.setOnCancelListener(new CancellationSignal.OnCancelListener() {
                /* class androidx.fragment.app.SpecialEffectsController.Operation.C03641 */
        ...
        public final void mergeWith(State finalState, LifecycleImpact lifecycleImpact) {
            switch (C03633.f75xb9e640f0[lifecycleImpact.ordinal()]) {
                case 1:
    ...
    public static /* synthetic */ class C03633 {

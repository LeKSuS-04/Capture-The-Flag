...
public abstract class ComputableLiveData<T> {
    ...
    public ComputableLiveData(Executor executor) {
        ...
        this.mRefreshRunnable = new Runnable() {
            /* class androidx.lifecycle.ComputableLiveData.RunnableC03712 */
        ...
        this.mInvalidationRunnable = new Runnable() {
            /* class androidx.lifecycle.ComputableLiveData.RunnableC03723 */
        ...
        this.mLiveData = new LiveData<T>() {
            /* class androidx.lifecycle.ComputableLiveData.C03701 */

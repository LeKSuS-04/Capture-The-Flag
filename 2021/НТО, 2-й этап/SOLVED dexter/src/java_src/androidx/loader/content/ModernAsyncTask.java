...
public abstract class ModernAsyncTask<Params, Progress, Result> {
    ...
    static {
        ThreadFactoryC03951 r7 = new ThreadFactory() {
            /* class androidx.loader.content.ModernAsyncTask.ThreadFactoryC03951 */
    ...
    ModernAsyncTask() {
        C03962 r0 = new WorkerRunnable<Params, Result>() {
            /* class androidx.loader.content.ModernAsyncTask.C03962 */
        ...
        this.mFuture = new FutureTask<Result>(r0) {
            /* class androidx.loader.content.ModernAsyncTask.C03973 */
    ...
    public static /* synthetic */ class C03984 {
    ...
    public final ModernAsyncTask<Params, Progress, Result> executeOnExecutor(Executor exec, Params... params) {
        if (this.mStatus != Status.PENDING) {
            switch (C03984.$SwitchMap$androidx$loader$content$ModernAsyncTask$Status[this.mStatus.ordinal()]) {
                case 1:

        ...
        if (newList != list) {
            ...
            if (newList == null) {
                ...
                this.mConfig.getBackgroundThreadExecutor().execute(new Runnable() {
                    /* class androidx.recyclerview.widget.AsyncListDiffer.RunnableC04091 */

                    public void run() {
                        final DiffUtil.DiffResult result = DiffUtil.calculateDiff(new DiffUtil.Callback() {
                            /* class androidx.recyclerview.widget.AsyncListDiffer.RunnableC04091.C04101 */
                        ...
                        AsyncListDiffer.this.mMainThreadExecutor.execute(new Runnable() {
                            /* class androidx.recyclerview.widget.AsyncListDiffer.RunnableC04091.RunnableC04112 */

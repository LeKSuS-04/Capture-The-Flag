...
import androidx.recyclerview.C0405R;
...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild2, NestedScrollingChild3 {
    ...
    static final Interpolator sQuinticInterpolator = new Interpolator() {
        /* class androidx.recyclerview.widget.RecyclerView.animationInterpolatorC04453 */
    ...
    public RecyclerView(Context context, AttributeSet attrs) {
        this(context, attrs, C0405R.attr.recyclerViewStyle);
    }
    ...
    public RecyclerView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        this.mUpdateChildViewsRunnable = new Runnable() {
            /* class androidx.recyclerview.widget.RecyclerView.RunnableC04431 */
        ...
        this.mItemAnimatorRunner = new Runnable() {
            /* class androidx.recyclerview.widget.RecyclerView.RunnableC04442 */
        ...
        this.mViewInfoProcessCallback = new ViewInfoStore.ProcessCallback() {
            /* class androidx.recyclerview.widget.RecyclerView.C04464 */
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, C0405R.styleable.RecyclerView, defStyleAttr, 0);
        if (Build.VERSION.SDK_INT >= 29) {
            saveAttributeDataForStyleable(context, C0405R.styleable.RecyclerView, attrs, a, defStyleAttr, 0);
        }
        String layoutManagerName = a.getString(C0405R.styleable.RecyclerView_layoutManager);
        if (a.getInt(C0405R.styleable.RecyclerView_android_descendantFocusability, -1) == -1) {
            setDescendantFocusability(262144);
        }
        this.mClipToPadding = a.getBoolean(C0405R.styleable.RecyclerView_android_clipToPadding, true);
        boolean z = a.getBoolean(C0405R.styleable.RecyclerView_fastScrollEnabled, false);
        this.mEnableFastScroller = z;
        if (z) {
            initFastScroller((StateListDrawable) a.getDrawable(C0405R.styleable.RecyclerView_fastScrollVerticalThumbDrawable), a.getDrawable(C0405R.styleable.RecyclerView_fastScrollVerticalTrackDrawable), (StateListDrawable) a.getDrawable(C0405R.styleable.RecyclerView_fastScrollHorizontalThumbDrawable), a.getDrawable(C0405R.styleable.RecyclerView_fastScrollHorizontalTrackDrawable));
        }
        a.recycle();
    ...
    private void initChildrenHelper() {
        this.mChildHelper = new ChildHelper(new ChildHelper.Callback() {
            /* class androidx.recyclerview.widget.RecyclerView.C04475 */
    ...
    public void initAdapterManager() {
        this.mAdapterHelper = new AdapterHelper(new AdapterHelper.Callback() {
            /* class androidx.recyclerview.widget.RecyclerView.C04486 */
    ...
    public boolean scrollByInternal(int x, int y, MotionEvent ev) {
        ...
        if (!consumedNestedScroll && consumedX == 0 && consumedY2 == 0) {
            return false;
        }
        return true;
    }
    ...
    public static abstract class LayoutManager {
        ...
        public LayoutManager() {
            C04491 r0 = new ViewBoundsCheck.Callback() {
                /* class androidx.recyclerview.widget.RecyclerView.LayoutManager.C04491 */
            ...
            C04502 r1 = new ViewBoundsCheck.Callback() {
                /* class androidx.recyclerview.widget.RecyclerView.LayoutManager.C04502 */
        ...
        public static Properties getProperties(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
            ...
            TypedArray a = context.obtainStyledAttributes(attrs, C0405R.styleable.RecyclerView, defStyleAttr, defStyleRes);
            properties.orientation = a.getInt(C0405R.styleable.RecyclerView_android_orientation, 1);
            properties.spanCount = a.getInt(C0405R.styleable.RecyclerView_spanCount, 1);
            properties.reverseLayout = a.getBoolean(C0405R.styleable.RecyclerView_reverseLayout, false);
            properties.stackFromEnd = a.getBoolean(C0405R.styleable.RecyclerView_stackFromEnd, false);
            a.recycle();
            return properties;
        }
    ...
    public void initFastScroller(StateListDrawable verticalThumbDrawable, Drawable verticalTrackDrawable, StateListDrawable horizontalThumbDrawable, Drawable horizontalTrackDrawable) {
        ...
        new FastScroller(this, verticalThumbDrawable, verticalTrackDrawable, horizontalThumbDrawable, horizontalTrackDrawable, resources.getDimensionPixelSize(C0405R.dimen.fastscroll_default_thickness), resources.getDimensionPixelSize(C0405R.dimen.fastscroll_minimum_range), resources.getDimensionPixelOffset(C0405R.dimen.fastscroll_margin));
    }
    ...
    public static class SavedState extends AbsSavedState {
        public static final Parcelable.Creator<SavedState> CREATOR = new Parcelable.ClassLoaderCreator<SavedState>() {
            /* class androidx.recyclerview.widget.RecyclerView.SavedState.C04511 */

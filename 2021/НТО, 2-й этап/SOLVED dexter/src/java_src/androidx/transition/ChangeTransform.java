...
public class ChangeTransform extends Transition {
    private static final Property<PathAnimatorMatrix, float[]> NON_TRANSLATIONS_PROPERTY = new Property<PathAnimatorMatrix, float[]>(float[].class, "nonTranslations") {
        /* class androidx.transition.ChangeTransform.C04751 */
    ...
    private static final Property<PathAnimatorMatrix, PointF> TRANSLATIONS_PROPERTY = new Property<PathAnimatorMatrix, PointF>(PointF.class, "translations") {
        /* class androidx.transition.ChangeTransform.C04762 */
    ...
    private void captureValues(TransitionValues transitionValues) {
        ...
        if (view.getVisibility() != 8) {
            ...
            if (this.mReparent) {
                ...
                transitionValues.values.put(PROPNAME_INTERMEDIATE_MATRIX, view.getTag(C0485R.C0488id.transition_transform));
                transitionValues.values.put(PROPNAME_INTERMEDIATE_PARENT_MATRIX, view.getTag(C0485R.C0488id.parent_matrix));
            }
        }
    }
    ...
    private ObjectAnimator createTransformAnimator(TransitionValues startValues, TransitionValues endValues, final boolean handleParentChange) {
        ...
        AnimatorListenerAdapter listener = new AnimatorListenerAdapter() {
            /* class androidx.transition.ChangeTransform.C04773 */
            ...
            public void onAnimationEnd(Animator animation) {
                if (!this.mIsCanceled) {
                    if (!handleParentChange || !ChangeTransform.this.mUseOverlay) {
                        view.setTag(C0485R.C0488id.transition_transform, null);
                        view.setTag(C0485R.C0488id.parent_matrix, null);
                    } else {
            ...
            private void setCurrentMatrix(Matrix currentMatrix) {
                ...
                view.setTag(C0485R.C0488id.transition_transform, this.mTempMatrix);
                transforms.restore(view);
            }
        };
    ...
    private void setMatricesForParent(TransitionValues startValues, TransitionValues endValues) {
        ...
        endValues.view.setTag(C0485R.C0488id.parent_matrix, endParentMatrix);
    ...
    public static class GhostListener extends TransitionListenerAdapter {
        ...
        public void onTransitionEnd(Transition transition) {
            ...
            this.mView.setTag(C0485R.C0488id.transition_transform, null);
            this.mView.setTag(C0485R.C0488id.parent_matrix, null);
        }

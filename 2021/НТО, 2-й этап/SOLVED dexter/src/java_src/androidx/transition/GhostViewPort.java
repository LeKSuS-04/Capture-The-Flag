...
public class GhostViewPort extends ViewGroup implements GhostView {
    ...
    private final ViewTreeObserver.OnPreDrawListener mOnPreDrawListener = new ViewTreeObserver.OnPreDrawListener() {
        /* class androidx.transition.GhostViewPort.ViewTreeObserver$OnPreDrawListenerC04831 */
    ...
    static GhostViewPort getGhostView(View view) {
        return (GhostViewPort) view.getTag(C0485R.C0488id.ghost_view);
    }

    static void setGhostView(View view, GhostViewPort ghostView) {
        view.setTag(C0485R.C0488id.ghost_view, ghostView);
    }

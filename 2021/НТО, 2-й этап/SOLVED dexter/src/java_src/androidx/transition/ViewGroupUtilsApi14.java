...
public class ViewGroupUtilsApi14 {
    ...
    static void suppressLayout(ViewGroup group, boolean suppress) {
        if (sEmptyLayoutTransition == null) {
            C05001 r0 = new LayoutTransition() {
                /* class androidx.transition.ViewGroupUtilsApi14.C05001 */
        ...
        if (suppress) {
            ...
            if (layoutTransition != null) {
                ...
                if (layoutTransition != sEmptyLayoutTransition) {
                    group.setTag(C0485R.C0488id.transition_layout_save, layoutTransition);
                }
            }
        ...
        LayoutTransition layoutTransition2 = (LayoutTransition) group.getTag(C0485R.C0488id.transition_layout_save);
        if (layoutTransition2 != null) {
            group.setTag(C0485R.C0488id.transition_layout_save, null);

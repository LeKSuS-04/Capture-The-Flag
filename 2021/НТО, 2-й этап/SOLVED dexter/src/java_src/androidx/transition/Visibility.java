...
public abstract class Visibility extends Transition {
    ...
    public Animator onDisappear(final ViewGroup sceneRoot, TransitionValues startValues, int startVisibility, TransitionValues endValues, int endVisibility) {
        ...
        View savedOverlayView = (View) startView.getTag(C0485R.C0488id.save_overlay_view);
        ...
        if (overlayView != null) {
            ...
            if (!reusingOverlayView) {
                if (animator == null) {
                    ...
                    startView.setTag(C0485R.C0488id.save_overlay_view, overlayView);
                    addListener(new TransitionListenerAdapter() {
                        /* class androidx.transition.Visibility.C05031 */
                        ...
                        public void onTransitionEnd(Transition transition) {
                            startView.setTag(C0485R.C0488id.save_overlay_view, null);
                            ViewGroupUtils.getOverlay(sceneRoot).remove(overlayView);

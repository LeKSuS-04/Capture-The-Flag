...
public class AnimatedVectorDrawableCompat extends VectorDrawableCommon implements Animatable2Compat {
    ...
    private AnimatedVectorDrawableCompat(Context context, AnimatedVectorDrawableCompatState state, Resources res) {
        ...
        C05131 r0 = new Drawable.Callback() {
            /* class androidx.vectordrawable.graphics.drawable.AnimatedVectorDrawableCompat.C05131 */
            ...
            if (!this.mAnimationCallbacks.contains(callback)) {
                ...
                if (this.mAnimatorListener == null) {
                    this.mAnimatorListener = new AnimatorListenerAdapter() {
                        /* class androidx.vectordrawable.graphics.drawable.AnimatedVectorDrawableCompat.C05142 */

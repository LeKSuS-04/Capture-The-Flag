...
public abstract class FragmentStateAdapter extends RecyclerView.Adapter<FragmentViewHolder> implements StatefulAdapter {
        ...
        if (ViewCompat.isAttachedToWindow(container)) {
            if (container.getParent() == null) {
                container.addOnLayoutChangeListener(new View.OnLayoutChangeListener() {
                    /* class androidx.viewpager2.adapter.FragmentStateAdapter.View$OnLayoutChangeListenerC05351 */
            ...
            if (!fragment.isAdded() && view != null) {
                ...
                if (fragment.isAdded()) {
                    ...
                    this.mLifecycle.addObserver(new LifecycleEventObserver() {
                        /* class androidx.viewpager2.adapter.FragmentStateAdapter.C05362 */
    ...
    private void scheduleViewAttach(final Fragment fragment, final FrameLayout container) {
        this.mFragmentManager.registerFragmentLifecycleCallbacks(new FragmentManager.FragmentLifecycleCallbacks() {
            /* class androidx.viewpager2.adapter.FragmentStateAdapter.C05373 */
    ...
    private void scheduleGracePeriodEnd() {
        ...
        final Runnable runnable = new Runnable() {
            /* class androidx.viewpager2.adapter.FragmentStateAdapter.RunnableC05384 */
        ...
        this.mLifecycle.addObserver(new LifecycleEventObserver() {
            /* class androidx.viewpager2.adapter.FragmentStateAdapter.C05395 */
    ...
    public class FragmentMaxLifecycleEnforcer {
        ...
        public void register(RecyclerView recyclerView) {
            ...
            C05401 r0 = new ViewPager2.OnPageChangeCallback() {
                /* class androidx.viewpager2.adapter.FragmentStateAdapter.FragmentMaxLifecycleEnforcer.C05401 */
            ...
            C05412 r02 = new DataSetChangeObserver() {
                /* class androidx.viewpager2.adapter.FragmentStateAdapter.FragmentMaxLifecycleEnforcer.C05412 */
            ...
            this.mLifecycleObserver = new LifecycleEventObserver() {
                /* class androidx.viewpager2.adapter.FragmentStateAdapter.FragmentMaxLifecycleEnforcer.C05423 */

...
public class AppBarLayout extends LinearLayout implements CoordinatorLayout.AttachedBehavior {
    private static final int DEF_STYLE_RES = C0552R.style.Widget_Design_AppBarLayout;
    ...
    public AppBarLayout(Context context, AttributeSet attrs) {
        this(context, attrs, C0552R.attr.appBarLayoutStyle);
    }
    ...
    public AppBarLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a = ThemeEnforcement.obtainStyledAttributes(context2, attrs, C0552R.styleable.AppBarLayout, defStyleAttr, i, new int[0]);
        ViewCompat.setBackground(this, a.getDrawable(C0552R.styleable.AppBarLayout_android_background));
        ...
        if (a.hasValue(C0552R.styleable.AppBarLayout_expanded)) {
            setExpanded(a.getBoolean(C0552R.styleable.AppBarLayout_expanded, false), false, false);
        }
        if (Build.VERSION.SDK_INT >= 21 && a.hasValue(C0552R.styleable.AppBarLayout_elevation)) {
            ViewUtilsLollipop.setDefaultAppBarLayoutStateListAnimator(this, (float) a.getDimensionPixelSize(C0552R.styleable.AppBarLayout_elevation, 0));
        }
        if (Build.VERSION.SDK_INT >= 26) {
            if (a.hasValue(C0552R.styleable.AppBarLayout_android_keyboardNavigationCluster)) {
                setKeyboardNavigationCluster(a.getBoolean(C0552R.styleable.AppBarLayout_android_keyboardNavigationCluster, false));
            }
            if (a.hasValue(C0552R.styleable.AppBarLayout_android_touchscreenBlocksFocus)) {
                setTouchscreenBlocksFocus(a.getBoolean(C0552R.styleable.AppBarLayout_android_touchscreenBlocksFocus, false));
            }
        }
        this.liftOnScroll = a.getBoolean(C0552R.styleable.AppBarLayout_liftOnScroll, false);
        this.liftOnScrollTargetViewId = a.getResourceId(C0552R.styleable.AppBarLayout_liftOnScrollTargetViewId, -1);
        setStatusBarForeground(a.getDrawable(C0552R.styleable.AppBarLayout_statusBarForeground));
        a.recycle();
        ViewCompat.setOnApplyWindowInsetsListener(this, new OnApplyWindowInsetsListener() {
            /* class com.google.android.material.appbar.AppBarLayout.C05571 */
    ...
    public int[] onCreateDrawableState(int extraSpace) {
        ...
        extraStates[0] = this.liftable ? C0552R.attr.state_liftable : -C0552R.attr.state_liftable;
        extraStates[1] = (!this.liftable || !this.lifted) ? -C0552R.attr.state_lifted : C0552R.attr.state_lifted;
        extraStates[2] = this.liftable ? C0552R.attr.state_collapsible : -C0552R.attr.state_collapsible;
        extraStates[3] = (!this.liftable || !this.lifted) ? -C0552R.attr.state_collapsed : C0552R.attr.state_collapsed;
    ...
    private void startLiftOnScrollElevationOverlayAnimation(final MaterialShapeDrawable background, boolean lifted2) {
        float appBarElevation = getResources().getDimension(C0552R.dimen.design_appbar_elevation);
        ...
        ofFloat.setDuration((long) getResources().getInteger(C0552R.integer.app_bar_elevation_anim_duration));
        this.elevationOverlayAnimator.setInterpolator(AnimationUtils.LINEAR_INTERPOLATOR);
        this.elevationOverlayAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            /* class com.google.android.material.appbar.AppBarLayout.C05582 */
    ...
    public static class LayoutParams extends LinearLayout.LayoutParams {
        ...
        public LayoutParams(Context c, AttributeSet attrs) {
            super(c, attrs);
            TypedArray a = c.obtainStyledAttributes(attrs, C0552R.styleable.AppBarLayout_Layout);
            this.scrollFlags = a.getInt(C0552R.styleable.AppBarLayout_Layout_layout_scrollFlags, 0);
            if (a.hasValue(C0552R.styleable.AppBarLayout_Layout_layout_scrollInterpolator)) {
                this.scrollInterpolator = android.view.animation.AnimationUtils.loadInterpolator(c, a.getResourceId(C0552R.styleable.AppBarLayout_Layout_layout_scrollInterpolator, 0));
            }
            a.recycle();
        }
    ...
    public static class BaseBehavior<T extends AppBarLayout> extends HeaderBehavior<T> {
        ...
        private void animateOffsetWithDuration(final CoordinatorLayout coordinatorLayout, final T child, int offset, int duration) {
            ...
            if (valueAnimator2 == null) {
                ...
                this.offsetAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
                    /* class com.google.android.material.appbar.AppBarLayout.BaseBehavior.C05591 */
            ...
            if (scrollingView.canScrollVertically(-1)) {
                ...
                if (dy != 0) {
                    ViewCompat.replaceAccessibilityAction(coordinatorLayout, AccessibilityNodeInfoCompat.AccessibilityActionCompat.ACTION_SCROLL_BACKWARD, null, new AccessibilityViewCommand() {
                        /* class com.google.android.material.appbar.AppBarLayout.BaseBehavior.C05602 */
        ...
        private void addActionToExpand(CoordinatorLayout parent, final T appBarLayout, AccessibilityNodeInfoCompat.AccessibilityActionCompat action, final boolean expand) {
            ViewCompat.replaceAccessibilityAction(parent, action, null, new AccessibilityViewCommand() {
                /* class com.google.android.material.appbar.AppBarLayout.BaseBehavior.C05613 */
        ...
        public static class SavedState extends AbsSavedState {
            public static final Parcelable.Creator<SavedState> CREATOR = new Parcelable.ClassLoaderCreator<SavedState>() {
                /* class com.google.android.material.appbar.AppBarLayout.BaseBehavior.SavedState.C05621 */
    ...
    public static class ScrollingViewBehavior extends HeaderScrollingViewBehavior {
        ...
        public ScrollingViewBehavior(Context context, AttributeSet attrs) {
            super(context, attrs);
            TypedArray a = context.obtainStyledAttributes(attrs, C0552R.styleable.ScrollingViewBehavior_Layout);
            setOverlayTop(a.getDimensionPixelSize(C0552R.styleable.ScrollingViewBehavior_Layout_behavior_overlapTop, 0));
            a.recycle();
        }

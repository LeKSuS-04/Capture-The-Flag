...
public class BadgeDrawable extends Drawable implements TextDrawableHelper.TextDrawableDelegate {
    ...
    private static final int DEFAULT_STYLE = C0552R.style.Widget_MaterialComponents_Badge;
    private static final int DEFAULT_THEME_ATTR = C0552R.attr.badgeStyle;
    ...
    public static final class SavedState implements Parcelable {
        public static final Parcelable.Creator<SavedState> CREATOR = new Parcelable.Creator<SavedState>() {
            /* class com.google.android.material.badge.BadgeDrawable.SavedState.C05661 */
        ...
        public SavedState(Context context) {
            this.badgeTextColor = new TextAppearance(context, C0552R.style.TextAppearance_MaterialComponents_Badge).textColor.getDefaultColor();
            this.contentDescriptionNumberless = context.getString(C0552R.string.mtrl_badge_numberless_content_description);
            this.contentDescriptionQuantityStrings = C0552R.plurals.mtrl_badge_content_description;
            this.contentDescriptionExceedsMaxBadgeNumberRes = C0552R.string.mtrl_exceed_max_badge_number_content_description;
            this.isVisible = true;
        }
    ...
    private void loadDefaultStateFromAttributes(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        TypedArray a = ThemeEnforcement.obtainStyledAttributes(context, attrs, C0552R.styleable.Badge, defStyleAttr, defStyleRes, new int[0]);
        setMaxCharacterCount(a.getInt(C0552R.styleable.Badge_maxCharacterCount, 4));
        if (a.hasValue(C0552R.styleable.Badge_number)) {
            setNumber(a.getInt(C0552R.styleable.Badge_number, 0));
        }
        setBackgroundColor(readColorFromAttributes(context, a, C0552R.styleable.Badge_backgroundColor));
        if (a.hasValue(C0552R.styleable.Badge_badgeTextColor)) {
            setBadgeTextColor(readColorFromAttributes(context, a, C0552R.styleable.Badge_badgeTextColor));
        }
        setBadgeGravity(a.getInt(C0552R.styleable.Badge_badgeGravity, TOP_END));
        setHorizontalOffset(a.getDimensionPixelOffset(C0552R.styleable.Badge_horizontalOffset, 0));
        setVerticalOffset(a.getDimensionPixelOffset(C0552R.styleable.Badge_verticalOffset, 0));
        a.recycle();
    }
    ...
    private BadgeDrawable(Context context) {
        ...
        this.badgeRadius = (float) res.getDimensionPixelSize(C0552R.dimen.mtrl_badge_radius);
        this.badgeWidePadding = (float) res.getDimensionPixelSize(C0552R.dimen.mtrl_badge_long_text_horizontal_padding);
        this.badgeWithTextRadius = (float) res.getDimensionPixelSize(C0552R.dimen.mtrl_badge_with_text_radius);
        TextDrawableHelper textDrawableHelper2 = new TextDrawableHelper(this);
        this.textDrawableHelper = textDrawableHelper2;
        textDrawableHelper2.getTextPaint().setTextAlign(Paint.Align.CENTER);
        this.savedState = new SavedState(context);
        setTextAppearanceResource(C0552R.style.TextAppearance_MaterialComponents_Badge);
    }
    ...
    private void tryWrapAnchorInCompatParent(final View anchorView) {
        ...
        if (anchorViewParent == null || anchorViewParent.getId() != C0552R.C0555id.mtrl_anchor_parent) {
            WeakReference<FrameLayout> weakReference = this.customBadgeParentRef;
            if (weakReference == null || weakReference.get() != anchorViewParent) {
                ...
                frameLayout.setId(C0552R.C0555id.mtrl_anchor_parent);
                ...
                frameLayout.post(new Runnable() {
                    /* class com.google.android.material.badge.BadgeDrawable.RunnableC05651 */
    ...
    private void calculateCenterAndBounds(Context context, Rect anchorRect, View anchorView) {
        ...
        switch (this.savedState.badgeGravity) {
            case BOTTOM_START /*{ENCODED_INT: 8388691}*/:
            case BOTTOM_END /*{ENCODED_INT: 8388693}*/:
        ...
        int inset = context.getResources().getDimensionPixelSize(hasNumber() ? C0552R.dimen.mtrl_badge_text_horizontal_edge_offset : C0552R.dimen.mtrl_badge_horizontal_edge_offset);
        int totalHorizontalOffset = this.savedState.horizontalOffset + this.savedState.additionalHorizontalOffset;
        switch (this.savedState.badgeGravity) {
            case TOP_START /*{ENCODED_INT: 8388659}*/:
            case BOTTOM_START /*{ENCODED_INT: 8388691}*/:
    ...
    private String getBadgeText() {
        ...
        return context.getString(C0552R.string.mtrl_exceed_max_badge_number_suffix, Integer.valueOf(this.maxBadgeNumber), DEFAULT_EXCEED_MAX_BADGE_NUMBER_SUFFIX);
    }

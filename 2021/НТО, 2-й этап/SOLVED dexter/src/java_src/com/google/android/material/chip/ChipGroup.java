...
public class ChipGroup extends FlowLayout {
    private static final int DEF_STYLE_RES = C0552R.style.Widget_MaterialComponents_ChipGroup;
    ...
    public ChipGroup(Context context, AttributeSet attrs) {
        this(context, attrs, C0552R.attr.chipGroupStyle);
    }
    ...
    public ChipGroup(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a = ThemeEnforcement.obtainStyledAttributes(getContext(), attrs, C0552R.styleable.ChipGroup, defStyleAttr, i, new int[0]);
        int chipSpacing = a.getDimensionPixelOffset(C0552R.styleable.ChipGroup_chipSpacing, 0);
        setChipSpacingHorizontal(a.getDimensionPixelOffset(C0552R.styleable.ChipGroup_chipSpacingHorizontal, chipSpacing));
        setChipSpacingVertical(a.getDimensionPixelOffset(C0552R.styleable.ChipGroup_chipSpacingVertical, chipSpacing));
        setSingleLine(a.getBoolean(C0552R.styleable.ChipGroup_singleLine, false));
        setSingleSelection(a.getBoolean(C0552R.styleable.ChipGroup_singleSelection, false));
        setSelectionRequired(a.getBoolean(C0552R.styleable.ChipGroup_selectionRequired, false));
        int checkedChip = a.getResourceId(C0552R.styleable.ChipGroup_checkedChip, -1);
        if (checkedChip != -1) {
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void setCheckedId(int checkedId2, boolean fromUser) {

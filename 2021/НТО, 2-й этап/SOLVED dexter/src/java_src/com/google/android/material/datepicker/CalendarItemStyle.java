...
final class CalendarItemStyle {
    ...
    static CalendarItemStyle create(Context context, int materialCalendarItemStyle) {
        ...
        TypedArray styleableArray = context.obtainStyledAttributes(materialCalendarItemStyle, C0552R.styleable.MaterialCalendarItem);
        Rect insets2 = new Rect(styleableArray.getDimensionPixelOffset(C0552R.styleable.MaterialCalendarItem_android_insetLeft, 0), styleableArray.getDimensionPixelOffset(C0552R.styleable.MaterialCalendarItem_android_insetTop, 0), styleableArray.getDimensionPixelOffset(C0552R.styleable.MaterialCalendarItem_android_insetRight, 0), styleableArray.getDimensionPixelOffset(C0552R.styleable.MaterialCalendarItem_android_insetBottom, 0));
        ColorStateList backgroundColor2 = MaterialResources.getColorStateList(context, styleableArray, C0552R.styleable.MaterialCalendarItem_itemFillColor);
        ColorStateList textColor2 = MaterialResources.getColorStateList(context, styleableArray, C0552R.styleable.MaterialCalendarItem_itemTextColor);
        ColorStateList strokeColor2 = MaterialResources.getColorStateList(context, styleableArray, C0552R.styleable.MaterialCalendarItem_itemStrokeColor);
        int strokeWidth2 = styleableArray.getDimensionPixelSize(C0552R.styleable.MaterialCalendarItem_itemStrokeWidth, 0);
        ShapeAppearanceModel itemShape2 = ShapeAppearanceModel.builder(context, styleableArray.getResourceId(C0552R.styleable.MaterialCalendarItem_itemShapeAppearance, 0), styleableArray.getResourceId(C0552R.styleable.MaterialCalendarItem_itemShapeAppearanceOverlay, 0)).build();

...
public final class MaterialCalendar<S> extends PickerFragment<S> {
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        if (MaterialDatePicker.isFullscreen(themedContext)) {
            layout = C0552R.layout.mtrl_calendar_vertical;
            orientation = 1;
        } else {
            layout = C0552R.layout.mtrl_calendar_horizontal;
            orientation = 0;
        }
        View root = themedInflater.inflate(layout, viewGroup, false);
        GridView daysHeader = (GridView) root.findViewById(C0552R.C0555id.mtrl_calendar_days_of_week);
        ViewCompat.setAccessibilityDelegate(daysHeader, new AccessibilityDelegateCompat() {
            /* class com.google.android.material.datepicker.MaterialCalendar.C06131 */
        ...
        this.recyclerView = (RecyclerView) root.findViewById(C0552R.C0555id.mtrl_calendar_months);
        this.recyclerView.setLayoutManager(new SmoothCalendarLayoutManager(getContext(), false, orientation) {
            /* class com.google.android.material.datepicker.MaterialCalendar.C06152 */
        ...
        MonthsPagerAdapter monthsPagerAdapter = new MonthsPagerAdapter(themedContext, this.dateSelector, this.calendarConstraints, new OnDayClickListener() {
            /* class com.google.android.material.datepicker.MaterialCalendar.C06163 */

            /* JADX DEBUG: Multi-variable search result rejected for r1v2, resolved type: com.google.android.material.datepicker.OnSelectionChangedListener */
        ...
        int columns = themedContext.getResources().getInteger(C0552R.integer.mtrl_calendar_year_selector_span);
        RecyclerView recyclerView2 = (RecyclerView) root.findViewById(C0552R.C0555id.mtrl_calendar_year_selector_frame);
        ...
        if (root.findViewById(C0552R.C0555id.month_navigation_fragment_toggle) != null) {
    ...
    private RecyclerView.ItemDecoration createItemDecoration() {
        return new RecyclerView.ItemDecoration() {
            /* class com.google.android.material.datepicker.MaterialCalendar.C06174 */
                            ...
                            if (range2.second != null) {
                                ...
                                while (row <= lastRow) {
                                    ...
                                    if (viewInRow == null) {
                                        ...
                                        range = range2;
                                        firstHighlightPosition = firstHighlightPosition2;
                                        canvas.drawRect((float) left, (float) top, (float) right, (float) bottom, MaterialCalendar.this.calendarStyle.rangeFill);
                                    }
                                    row++;
                                    adapter2 = adapter;
    ...
    static int getDayHeight(Context context) {
        return context.getResources().getDimensionPixelSize(C0552R.dimen.mtrl_calendar_day_height);
    }
    ...
    private void addActionsToMonthNavigation(View root, final MonthsPagerAdapter monthsPagerAdapter) {
        final MaterialButton monthDropSelect = (MaterialButton) root.findViewById(C0552R.C0555id.month_navigation_fragment_toggle);
        ...
        ViewCompat.setAccessibilityDelegate(monthDropSelect, new AccessibilityDelegateCompat() {
            /* class com.google.android.material.datepicker.MaterialCalendar.C06185 */
            ...
            public void onInitializeAccessibilityNodeInfo(View view, AccessibilityNodeInfoCompat accessibilityNodeInfoCompat) {
                ...
                if (MaterialCalendar.this.dayFrame.getVisibility() == 0) {
                    str = MaterialCalendar.this.getString(C0552R.string.mtrl_picker_toggle_to_year_selection);
                } else {
                    str = MaterialCalendar.this.getString(C0552R.string.mtrl_picker_toggle_to_day_selection);
                }
                accessibilityNodeInfoCompat.setHintText(str);
            }
        });
        MaterialButton monthPrev = (MaterialButton) root.findViewById(C0552R.C0555id.month_navigation_previous);
        monthPrev.setTag(NAVIGATION_PREV_TAG);
        MaterialButton monthNext = (MaterialButton) root.findViewById(C0552R.C0555id.month_navigation_next);
        monthNext.setTag(NAVIGATION_NEXT_TAG);
        this.yearFrame = root.findViewById(C0552R.C0555id.mtrl_calendar_year_selector_frame);
        this.dayFrame = root.findViewById(C0552R.C0555id.mtrl_calendar_day_selector_frame);
        setSelector(CalendarSelector.DAY);
        monthDropSelect.setText(this.current.getLongName(root.getContext()));
        this.recyclerView.addOnScrollListener(new RecyclerView.OnScrollListener() {
            /* class com.google.android.material.datepicker.MaterialCalendar.C06196 */
        ...
        monthDropSelect.setOnClickListener(new View.OnClickListener() {
            /* class com.google.android.material.datepicker.MaterialCalendar.View$OnClickListenerC06207 */
        ...
        monthNext.setOnClickListener(new View.OnClickListener() {
            /* class com.google.android.material.datepicker.MaterialCalendar.View$OnClickListenerC06218 */
        ...
        monthPrev.setOnClickListener(new View.OnClickListener() {
            /* class com.google.android.material.datepicker.MaterialCalendar.View$OnClickListenerC06229 */
    ...
    private void postSmoothRecyclerViewScroll(final int position) {
        this.recyclerView.post(new Runnable() {
            /* class com.google.android.material.datepicker.MaterialCalendar.RunnableC061410 */

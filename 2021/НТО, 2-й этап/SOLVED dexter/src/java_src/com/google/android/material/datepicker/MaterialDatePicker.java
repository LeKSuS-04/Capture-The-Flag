...
public final class MaterialDatePicker<S> extends DialogFragment {
    ...
    public final Dialog onCreateDialog(Bundle bundle) {
        ...
        int surfaceColor = MaterialAttributes.resolveOrThrow(context, C0552R.attr.colorSurface, MaterialDatePicker.class.getCanonicalName());
        MaterialShapeDrawable materialShapeDrawable = new MaterialShapeDrawable(context, null, C0552R.attr.materialCalendarStyle, C0552R.style.Widget_MaterialComponents_MaterialCalendar);
    ...
    public final View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        View root = layoutInflater.inflate(this.fullscreen ? C0552R.layout.mtrl_picker_fullscreen : C0552R.layout.mtrl_picker_dialog, viewGroup);
        Context context = root.getContext();
        if (this.fullscreen) {
            root.findViewById(C0552R.C0555id.mtrl_calendar_frame).setLayoutParams(new LinearLayout.LayoutParams(getPaddedPickerWidth(context), -2));
        } else {
            View pane = root.findViewById(C0552R.C0555id.mtrl_calendar_main_pane);
            View frame = root.findViewById(C0552R.C0555id.mtrl_calendar_frame);
        ...
        TextView textView = (TextView) root.findViewById(C0552R.C0555id.mtrl_picker_header_selection_text);
        this.headerSelectionText = textView;
        ViewCompat.setAccessibilityLiveRegion(textView, 1);
        this.headerToggleButton = (CheckableImageButton) root.findViewById(C0552R.C0555id.mtrl_picker_header_toggle);
        TextView titleTextView = (TextView) root.findViewById(C0552R.C0555id.mtrl_picker_title_text);
        ...
        this.confirmButton = (Button) root.findViewById(C0552R.C0555id.confirm_button);
        ...
        this.confirmButton.setOnClickListener(new View.OnClickListener() {
            /* class com.google.android.material.datepicker.MaterialDatePicker.View$OnClickListenerC06241 */

            /* JADX DEBUG: Multi-variable search result rejected for r1v2, resolved type: com.google.android.material.datepicker.MaterialPickerOnPositiveButtonClickListener */
        ...
        Button cancelButton = (Button) root.findViewById(C0552R.C0555id.cancel_button);
        cancelButton.setTag(CANCEL_BUTTON_TAG);
        cancelButton.setOnClickListener(new View.OnClickListener() {
            /* class com.google.android.material.datepicker.MaterialDatePicker.View$OnClickListenerC06252 */
    ...
    public void onStart() {
        ...
        if (this.fullscreen) {
            ...
            int inset = getResources().getDimensionPixelOffset(C0552R.dimen.mtrl_calendar_dialog_background_inset);
    ...
    private void updateHeader() {
        ...
        this.headerSelectionText.setContentDescription(String.format(getString(C0552R.string.mtrl_picker_announce_current_selection), headerText));
    ...
    private void startPickerFragment() {
        ...
        fragmentTransaction.replace(C0552R.C0555id.mtrl_calendar_frame, this.pickerFragment);
        fragmentTransaction.commitNow();
        this.pickerFragment.addOnSelectionChangedListener(new OnSelectionChangedListener<S>() {
            /* class com.google.android.material.datepicker.MaterialDatePicker.C06263 */
    ...
    private void initHeaderToggle(Context context) {
        ...
        this.headerToggleButton.setOnClickListener(new View.OnClickListener() {
            /* class com.google.android.material.datepicker.MaterialDatePicker.View$OnClickListenerC06274 */
    ...
    private void updateToggleContentDescription(CheckableImageButton toggle) {
        ...
        if (this.headerToggleButton.isChecked()) {
            contentDescription = toggle.getContext().getString(C0552R.string.mtrl_picker_toggle_to_calendar_input_mode);
        } else {
            contentDescription = toggle.getContext().getString(C0552R.string.mtrl_picker_toggle_to_text_input_mode);
        }
    ...
    private static Drawable createHeaderToggleDrawable(Context context) {
        ...
        toggleDrawable.addState(new int[]{16842912}, AppCompatResources.getDrawable(context, C0552R.C0554drawable.material_ic_calendar_black_24dp));
        toggleDrawable.addState(new int[0], AppCompatResources.getDrawable(context, C0552R.C0554drawable.material_ic_edit_black_24dp));
    ...
    static boolean isNestedScrollable(Context context) {
        return readMaterialCalendarStyleBoolean(context, C0552R.attr.nestedScrollable);
    }

    static boolean readMaterialCalendarStyleBoolean(Context context, int attributeResId) {
        TypedArray a = context.obtainStyledAttributes(MaterialAttributes.resolveOrThrow(context, C0552R.attr.materialCalendarStyle, MaterialCalendar.class.getCanonicalName()), new int[]{attributeResId});
    ...
    private static int getDialogPickerHeight(Context context) {
        ...
        int navigationHeight = resources.getDimensionPixelSize(C0552R.dimen.mtrl_calendar_navigation_height) + resources.getDimensionPixelOffset(C0552R.dimen.mtrl_calendar_navigation_top_padding) + resources.getDimensionPixelOffset(C0552R.dimen.mtrl_calendar_navigation_bottom_padding);
        int daysOfWeekHeight = resources.getDimensionPixelSize(C0552R.dimen.mtrl_calendar_days_of_week_height);
        return navigationHeight + daysOfWeekHeight + (MonthAdapter.MAXIMUM_WEEKS * resources.getDimensionPixelSize(C0552R.dimen.mtrl_calendar_day_height)) + ((MonthAdapter.MAXIMUM_WEEKS - 1) * resources.getDimensionPixelOffset(C0552R.dimen.mtrl_calendar_month_vertical_padding)) + resources.getDimensionPixelOffset(C0552R.dimen.mtrl_calendar_bottom_padding);
    }

    private static int getPaddedPickerWidth(Context context) {
        Resources resources = context.getResources();
        int padding = resources.getDimensionPixelOffset(C0552R.dimen.mtrl_calendar_content_padding);
        int daysInWeek = Month.current().daysInWeek;
        return (padding * 2) + (daysInWeek * resources.getDimensionPixelSize(C0552R.dimen.mtrl_calendar_day_width)) + ((daysInWeek - 1) * resources.getDimensionPixelOffset(C0552R.dimen.mtrl_calendar_month_horizontal_padding));
    }

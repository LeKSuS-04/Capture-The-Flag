...
public class NavigationMenuItemView extends ForegroundLinearLayout implements MenuView.ItemView {
    ...
    public NavigationMenuItemView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        C06571 r0 = new AccessibilityDelegateCompat() {
            /* class com.google.android.material.internal.NavigationMenuItemView.C06571 */
        ...
        setOrientation(0);
        LayoutInflater.from(context).inflate(C0552R.layout.design_navigation_menu_item, (ViewGroup) this, true);
        setIconSize(context.getResources().getDimensionPixelSize(C0552R.dimen.design_navigation_icon_size));
        CheckedTextView checkedTextView = (CheckedTextView) findViewById(C0552R.C0555id.design_menu_item_text);
    ...
    private void setActionView(View actionView) {
        if (actionView != null) {
            if (this.actionArea == null) {
                this.actionArea = (FrameLayout) ((ViewStub) findViewById(C0552R.C0555id.design_menu_item_action_area_stub)).inflate();
            }
    ...
    public void setIcon(Drawable icon) {
        if (icon != null) {
            ...
            if (this.emptyDrawable == null) {
                Drawable drawable = ResourcesCompat.getDrawable(getResources(), C0552R.C0554drawable.navigation_empty_icon, getContext().getTheme());

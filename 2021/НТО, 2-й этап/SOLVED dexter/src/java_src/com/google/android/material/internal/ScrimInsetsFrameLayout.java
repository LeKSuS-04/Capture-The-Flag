...
public class ScrimInsetsFrameLayout extends FrameLayout {
    ...
    public ScrimInsetsFrameLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a = ThemeEnforcement.obtainStyledAttributes(context, attrs, C0552R.styleable.ScrimInsetsFrameLayout, defStyleAttr, C0552R.style.Widget_Design_ScrimInsetsFrameLayout, new int[0]);
        this.insetForeground = a.getDrawable(C0552R.styleable.ScrimInsetsFrameLayout_insetForeground);
        a.recycle();
        setWillNotDraw(true);
        ViewCompat.setOnApplyWindowInsetsListener(this, new OnApplyWindowInsetsListener() {
            /* class com.google.android.material.internal.ScrimInsetsFrameLayout.C06621 */

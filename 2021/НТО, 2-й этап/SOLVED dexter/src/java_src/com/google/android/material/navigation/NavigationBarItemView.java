...
public abstract class NavigationBarItemView extends FrameLayout implements MenuView.ItemView {
    ...
    public NavigationBarItemView(Context context) {
        ...
        this.icon = (ImageView) findViewById(C0552R.C0555id.navigation_bar_item_icon_view);
        ViewGroup viewGroup = (ViewGroup) findViewById(C0552R.C0555id.navigation_bar_item_labels_group);
        this.labelGroup = viewGroup;
        TextView textView = (TextView) findViewById(C0552R.C0555id.navigation_bar_item_small_label_view);
        this.smallLabel = textView;
        TextView textView2 = (TextView) findViewById(C0552R.C0555id.navigation_bar_item_large_label_view);
        this.largeLabel = textView2;
        setBackgroundResource(getItemBackgroundResId());
        this.defaultMargin = getResources().getDimensionPixelSize(getItemDefaultMarginResId());
        viewGroup.setTag(C0552R.C0555id.mtrl_view_tag_bottom_padding, Integer.valueOf(viewGroup.getPaddingBottom()));
        ...
        if (imageView != null) {
            imageView.addOnLayoutChangeListener(new View.OnLayoutChangeListener() {
                /* class com.google.android.material.navigation.NavigationBarItemView.View$OnLayoutChangeListenerC06701 */
        ...
        switch (this.labelVisibilityMode) {
            case -1:
                if (!this.isShifting) {
                    ...
                    updateViewPaddingBottom(viewGroup, ((Integer) viewGroup.getTag(C0552R.C0555id.mtrl_view_tag_bottom_padding)).intValue());
                    if (!checked) {
                    ...
                    if (checked) {
                        ...
                        updateViewPaddingBottom(viewGroup2, ((Integer) viewGroup2.getTag(C0552R.C0555id.mtrl_view_tag_bottom_padding)).intValue());
            ...
            case 0:
                if (checked) {
                    ...
                    updateViewPaddingBottom(viewGroup3, ((Integer) viewGroup3.getTag(C0552R.C0555id.mtrl_view_tag_bottom_padding)).intValue());
                    this.largeLabel.setVisibility(0);
                } else {
                    setViewLayoutParams(this.icon, this.defaultMargin, 17);
                    updateViewPaddingBottom(this.labelGroup, 0);
            ...
            case 1:
                ...
                updateViewPaddingBottom(viewGroup4, ((Integer) viewGroup4.getTag(C0552R.C0555id.mtrl_view_tag_bottom_padding)).intValue());
                if (!checked) {
                    setViewLayoutParams(this.icon, this.defaultMargin, 49);
    ...
    public int getItemBackgroundResId() {
        return C0552R.C0554drawable.mtrl_navigation_bar_item_background;
    }

    /* access modifiers changed from: protected */
    public int getItemDefaultMarginResId() {
        return C0552R.dimen.mtrl_navigation_bar_item_default_margin;
    }
}

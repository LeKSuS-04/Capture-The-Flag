...
public abstract class BaseProgressIndicator<S extends BaseProgressIndicatorSpec> extends ProgressBar {
    ...
    static final int DEF_STYLE_RES = C0552R.style.Widget_MaterialComponents_ProgressIndicator;
    ...
    private final Runnable delayedHide = new Runnable() {
        /* class com.google.android.material.progressindicator.BaseProgressIndicator.RunnableC06802 */
    ...
    private final Runnable delayedShow = new Runnable() {
        /* class com.google.android.material.progressindicator.BaseProgressIndicator.RunnableC06791 */
    ...
    private final Animatable2Compat.AnimationCallback hideAnimationCallback = new Animatable2Compat.AnimationCallback() {
        /* class com.google.android.material.progressindicator.BaseProgressIndicator.C06824 */
    ...
    private final Animatable2Compat.AnimationCallback switchIndeterminateModeCallback = new Animatable2Compat.AnimationCallback() {
        /* class com.google.android.material.progressindicator.BaseProgressIndicator.C06813 */
    ...
    protected BaseProgressIndicator(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        TypedArray a = ThemeEnforcement.obtainStyledAttributes(context2, attrs, C0552R.styleable.BaseProgressIndicator, defStyleAttr, defStyleRes, new int[0]);
        this.showDelay = a.getInt(C0552R.styleable.BaseProgressIndicator_showDelay, -1);
        this.minHideDelay = Math.min(a.getInt(C0552R.styleable.BaseProgressIndicator_minHideDelay, -1), 1000);
        a.recycle();
    ...
    public void setIndicatorColor(int... indicatorColors) {
        if (indicatorColors.length == 0) {
            indicatorColors = new int[]{MaterialColors.getColor(getContext(), C0552R.attr.colorPrimary, -1)};
        }

...
public abstract class DrawableWithAnimatedVisibilityChange extends Drawable implements Animatable2Compat {
    ...
    private static final Property<DrawableWithAnimatedVisibilityChange, Float> GROW_FRACTION = new Property<DrawableWithAnimatedVisibilityChange, Float>(Float.class, "growFraction") {
        /* class com.google.android.material.progressindicator.DrawableWithAnimatedVisibilityChange.C06903 */
    ...
    private void setShowAnimator(ValueAnimator showAnimator2) {
        ...
        if (valueAnimator == null || !valueAnimator.isRunning()) {
            ...
            showAnimator2.addListener(new AnimatorListenerAdapter() {
                /* class com.google.android.material.progressindicator.DrawableWithAnimatedVisibilityChange.C06881 */
    ...
    private void setHideAnimator(ValueAnimator hideAnimator2) {
        ...
        if (valueAnimator == null || !valueAnimator.isRunning()) {
            ...
            hideAnimator2.addListener(new AnimatorListenerAdapter() {
                /* class com.google.android.material.progressindicator.DrawableWithAnimatedVisibilityChange.C06892 */

...
public class ShadowDrawableWrapper extends DrawableWrapper {
    ...
    public ShadowDrawableWrapper(Context context, Drawable content, float radius, float shadowSize2, float maxShadowSize2) {
        super(content);
        this.shadowStartColor = ContextCompat.getColor(context, C0552R.C0553color.design_fab_shadow_start_color);
        this.shadowMiddleColor = ContextCompat.getColor(context, C0552R.C0553color.design_fab_shadow_mid_color);
        this.shadowEndColor = ContextCompat.getColor(context, C0552R.C0553color.design_fab_shadow_end_color);
    ...
    private void drawShadow(Canvas canvas) {
        ...
        float shadowScaleTop2 = shadowOffset / (shadowOffset + (f - (SHADOW_TOP_SCALE * f)));

...
public abstract class BaseTransientBottomBar<B extends BaseTransientBottomBar<B>> {
    ...
    private static final int[] SNACKBAR_STYLE_ATTR = {C0552R.attr.snackbarStyle};
    ...
    static final Handler handler = new Handler(Looper.getMainLooper(), new Handler.Callback() {
        /* class com.google.android.material.snackbar.BaseTransientBottomBar.C07091 */
    ...
    protected BaseTransientBottomBar(Context context2, ViewGroup parent, View content, ContentViewCallback contentViewCallback2) {
        ...
        this.anchorViewLayoutListener = new ViewTreeObserver.OnGlobalLayoutListener() {
            /* class com.google.android.material.snackbar.BaseTransientBottomBar.ViewTreeObserver$OnGlobalLayoutListenerC07192 */
        ...
        this.bottomMarginGestureInsetRunnable = new Runnable() {
            /* class com.google.android.material.snackbar.BaseTransientBottomBar.RunnableC07203 */
        ...
        this.managerCallback = new SnackbarManager.Callback() {
            /* class com.google.android.material.snackbar.BaseTransientBottomBar.C07236 */
        ...
        if (parent == null) {
            ...
            ViewCompat.setOnApplyWindowInsetsListener(snackbarBaseLayout, new OnApplyWindowInsetsListener() {
                /* class com.google.android.material.snackbar.BaseTransientBottomBar.C07214 */
            ...
            ViewCompat.setAccessibilityDelegate(snackbarBaseLayout, new AccessibilityDelegateCompat() {
                /* class com.google.android.material.snackbar.BaseTransientBottomBar.C07225 */
    ...
    public int getSnackbarBaseLayoutResId() {
        return hasSnackbarStyleAttr() ? C0552R.layout.mtrl_layout_snackbar : C0552R.layout.design_layout_snackbar;
    }
    ...
    public final void showView() {
        this.view.setOnAttachStateChangeListener(new OnAttachStateChangeListener() {
            /* class com.google.android.material.snackbar.BaseTransientBottomBar.C07247 */
            ...
            public void onViewDetachedFromWindow(View v) {
                if (BaseTransientBottomBar.this.isShownOrQueued()) {
                    BaseTransientBottomBar.handler.post(new Runnable() {
                        /* class com.google.android.material.snackbar.BaseTransientBottomBar.C07247.RunnableC07251 */
        ...
        if (ViewCompat.isLaidOut(this.view)) {
            ...
            this.view.setOnLayoutChangeListener(new OnLayoutChangeListener() {
                /* class com.google.android.material.snackbar.BaseTransientBottomBar.C07268 */
    ...
    private void setUpBehavior(CoordinatorLayout.LayoutParams lp) {
        ...
        behavior2.setListener(new SwipeDismissBehavior.OnDismissListener() {
            /* class com.google.android.material.snackbar.BaseTransientBottomBar.C07279 */
    ...
    public void animateViewIn() {
        this.view.post(new Runnable() {
            /* class com.google.android.material.snackbar.BaseTransientBottomBar.RunnableC071010 */
    ...
    private void startFadeInAnimation() {
        ...
        animatorSet.addListener(new AnimatorListenerAdapter() {
            /* class com.google.android.material.snackbar.BaseTransientBottomBar.C071111 */
    ...
    private void startFadeOutAnimation(final int event) {
        ...
        animator.addListener(new AnimatorListenerAdapter() {
            /* class com.google.android.material.snackbar.BaseTransientBottomBar.C071212 */
    ...
    private ValueAnimator getAlphaAnimator(float... alphaValues) {
        ...
        animator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            /* class com.google.android.material.snackbar.BaseTransientBottomBar.C071313 */
    ...
    private ValueAnimator getScaleAnimator(float... scaleValues) {
        ...
        animator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            /* class com.google.android.material.snackbar.BaseTransientBottomBar.C071414 */
    ...
    private void startSlideInAnimation() {
        ...
        animator.addListener(new AnimatorListenerAdapter() {
            /* class com.google.android.material.snackbar.BaseTransientBottomBar.C071515 */
        ...
        animator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener(translationYBottom) {
            /* class com.google.android.material.snackbar.BaseTransientBottomBar.C071616 */
    ...
    private void startSlideOutAnimation(final int event) {
        ...
        animator.setDuration(250L);
        animator.addListener(new AnimatorListenerAdapter() {
            /* class com.google.android.material.snackbar.BaseTransientBottomBar.C071717 */
        ...
        animator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            /* class com.google.android.material.snackbar.BaseTransientBottomBar.C071818 */
    ...
    public static class SnackbarBaseLayout extends FrameLayout {
        private static final View.OnTouchListener consumeAllTouchListener = new View.OnTouchListener() {
            /* class com.google.android.material.snackbar.BaseTransientBottomBar.SnackbarBaseLayout.View$OnTouchListenerC07281 */
        ...
        protected SnackbarBaseLayout(Context context, AttributeSet attrs) {
            ...
            TypedArray a = context2.obtainStyledAttributes(attrs, C0552R.styleable.SnackbarLayout);
            if (a.hasValue(C0552R.styleable.SnackbarLayout_elevation)) {
                ViewCompat.setElevation(this, (float) a.getDimensionPixelSize(C0552R.styleable.SnackbarLayout_elevation, 0));
            }
            this.animationMode = a.getInt(C0552R.styleable.SnackbarLayout_animationMode, 0);
            this.backgroundOverlayColorAlpha = a.getFloat(C0552R.styleable.SnackbarLayout_backgroundOverlayColorAlpha, 1.0f);
            setBackgroundTintList(MaterialResources.getColorStateList(context2, a, C0552R.styleable.SnackbarLayout_backgroundTint));
            setBackgroundTintMode(ViewUtils.parseTintMode(a.getInt(C0552R.styleable.SnackbarLayout_backgroundTintMode, -1), PorterDuff.Mode.SRC_IN));
            this.actionTextColorAlpha = a.getFloat(C0552R.styleable.SnackbarLayout_actionTextColorAlpha, 1.0f);
            a.recycle();
        ...
        private Drawable createThemedBackground() {
            float cornerRadius = getResources().getDimension(C0552R.dimen.mtrl_snackbar_background_corner_radius);
            GradientDrawable background = new GradientDrawable();
            background.setShape(0);
            background.setCornerRadius(cornerRadius);
            background.setColor(MaterialColors.layer(this, C0552R.attr.colorSurface, C0552R.attr.colorOnSurface, getBackgroundOverlayColorAlpha()));

...
public class Snackbar extends BaseTransientBottomBar<Snackbar> {
    private static final int[] SNACKBAR_BUTTON_STYLE_ATTR = {C0552R.attr.snackbarButtonStyle};
    private static final int[] SNACKBAR_CONTENT_STYLE_ATTRS = {C0552R.attr.snackbarButtonStyle, C0552R.attr.snackbarTextViewStyle};
    ...
    private static Snackbar makeInternal(Context context, View view, CharSequence text, int duration) {
        ...
        if (parent != null) {
            ...
            SnackbarContentLayout content = (SnackbarContentLayout) LayoutInflater.from(context).inflate(hasSnackbarContentStyleAttrs(context) ? C0552R.layout.mtrl_layout_snackbar_include : C0552R.layout.design_layout_snackbar_include, parent, false);
    ...
    public Snackbar setAction(CharSequence text, final View.OnClickListener listener) {
        ...
        if (TextUtils.isEmpty(text) || listener == null) {
            ...
            tv.setOnClickListener(new View.OnClickListener() {
                /* class com.google.android.material.snackbar.Snackbar.View$OnClickListenerC07291 */

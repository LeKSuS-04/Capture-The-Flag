...
public class TabLayout extends HorizontalScrollView {
    ...
    private static final int DEF_STYLE_RES = C0552R.style.Widget_Design_TabLayout;
    ...
    public TabLayout(Context context, AttributeSet attrs) {
        this(context, attrs, C0552R.attr.tabStyle);
    }
    ...
    public TabLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a = ThemeEnforcement.obtainStyledAttributes(context2, attrs, C0552R.styleable.TabLayout, defStyleAttr, i, C0552R.styleable.TabLayout_tabTextAppearance);
        ...
        setSelectedTabIndicator(MaterialResources.getDrawable(context2, a, C0552R.styleable.TabLayout_tabIndicator));
        setSelectedTabIndicatorColor(a.getColor(C0552R.styleable.TabLayout_tabIndicatorColor, 0));
        slidingTabIndicator2.setSelectedIndicatorHeight(a.getDimensionPixelSize(C0552R.styleable.TabLayout_tabIndicatorHeight, -1));
        setSelectedTabIndicatorGravity(a.getInt(C0552R.styleable.TabLayout_tabIndicatorGravity, 0));
        setTabIndicatorFullWidth(a.getBoolean(C0552R.styleable.TabLayout_tabIndicatorFullWidth, true));
        setTabIndicatorAnimationMode(a.getInt(C0552R.styleable.TabLayout_tabIndicatorAnimationMode, 0));
        int dimensionPixelSize = a.getDimensionPixelSize(C0552R.styleable.TabLayout_tabPadding, 0);
        this.tabPaddingBottom = dimensionPixelSize;
        this.tabPaddingEnd = dimensionPixelSize;
        this.tabPaddingTop = dimensionPixelSize;
        this.tabPaddingStart = dimensionPixelSize;
        this.tabPaddingStart = a.getDimensionPixelSize(C0552R.styleable.TabLayout_tabPaddingStart, this.tabPaddingStart);
        this.tabPaddingTop = a.getDimensionPixelSize(C0552R.styleable.TabLayout_tabPaddingTop, this.tabPaddingTop);
        this.tabPaddingEnd = a.getDimensionPixelSize(C0552R.styleable.TabLayout_tabPaddingEnd, this.tabPaddingEnd);
        this.tabPaddingBottom = a.getDimensionPixelSize(C0552R.styleable.TabLayout_tabPaddingBottom, this.tabPaddingBottom);
        int resourceId = a.getResourceId(C0552R.styleable.TabLayout_tabTextAppearance, C0552R.style.TextAppearance_Design_Tab);
        this.tabTextAppearance = resourceId;
        TypedArray ta = context2.obtainStyledAttributes(resourceId, C0021R.styleable.TextAppearance);
        try {
            this.tabTextSize = (float) ta.getDimensionPixelSize(C0021R.styleable.TextAppearance_android_textSize, 0);
            this.tabTextColors = MaterialResources.getColorStateList(context2, ta, C0021R.styleable.TextAppearance_android_textColor);
            ta.recycle();
            if (a.hasValue(C0552R.styleable.TabLayout_tabTextColor)) {
                this.tabTextColors = MaterialResources.getColorStateList(context2, a, C0552R.styleable.TabLayout_tabTextColor);
            }
            if (a.hasValue(C0552R.styleable.TabLayout_tabSelectedTextColor)) {
                this.tabTextColors = createColorStateList(this.tabTextColors.getDefaultColor(), a.getColor(C0552R.styleable.TabLayout_tabSelectedTextColor, 0));
            }
            this.tabIconTint = MaterialResources.getColorStateList(context2, a, C0552R.styleable.TabLayout_tabIconTint);
            this.tabIconTintMode = ViewUtils.parseTintMode(a.getInt(C0552R.styleable.TabLayout_tabIconTintMode, -1), null);
            this.tabRippleColorStateList = MaterialResources.getColorStateList(context2, a, C0552R.styleable.TabLayout_tabRippleColor);
            this.tabIndicatorAnimationDuration = a.getInt(C0552R.styleable.TabLayout_tabIndicatorAnimationDuration, ANIMATION_DURATION);
            this.requestedTabMinWidth = a.getDimensionPixelSize(C0552R.styleable.TabLayout_tabMinWidth, -1);
            this.requestedTabMaxWidth = a.getDimensionPixelSize(C0552R.styleable.TabLayout_tabMaxWidth, -1);
            this.tabBackgroundResId = a.getResourceId(C0552R.styleable.TabLayout_tabBackground, 0);
            this.contentInsetStart = a.getDimensionPixelSize(C0552R.styleable.TabLayout_tabContentStart, 0);
            this.mode = a.getInt(C0552R.styleable.TabLayout_tabMode, 1);
            this.tabGravity = a.getInt(C0552R.styleable.TabLayout_tabGravity, 0);
            this.inlineLabel = a.getBoolean(C0552R.styleable.TabLayout_tabInlineLabel, false);
            this.unboundedRipple = a.getBoolean(C0552R.styleable.TabLayout_tabUnboundedRipple, false);
            a.recycle();
            Resources res = getResources();
            this.tabTextMultiLineSize = (float) res.getDimensionPixelSize(C0552R.dimen.design_tab_text_size_2line);
            this.scrollableTabMinWidth = res.getDimensionPixelSize(C0552R.dimen.design_tab_scrollable_min_width);
            applyModeAndGravity();
        } catch (Throwable th) {
            ta.recycle();
            throw th;
    ...
    private void ensureScrollAnimator() {
        if (this.scrollAnimator == null) {
            ...
            this.scrollAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
                /* class com.google.android.material.tabs.TabLayout.C07321 */
    ...
    public final class TabView extends LinearLayout {
        ...
        public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo info) {
            ...
            infoCompat.setRoleDescription(getResources().getString(C0552R.string.item_view_role_description));
        }
        ...
        private void inflateAndAddDefaultIconView() {
            ...
            ImageView imageView = (ImageView) LayoutInflater.from(getContext()).inflate(C0552R.layout.design_layout_tab_icon, iconViewParent, false);
        ...
        private void inflateAndAddDefaultTextView() {
            ...
            TextView textView2 = (TextView) LayoutInflater.from(getContext()).inflate(C0552R.layout.design_layout_tab_text, textViewParent, false);
        ...
        private void addOnLayoutChangeListener(final View view) {
            if (view != null) {
                view.addOnLayoutChangeListener(new View.OnLayoutChangeListener() {
                    /* class com.google.android.material.tabs.TabLayout.TabView.View$OnLayoutChangeListenerC07351 */
    ...
    public class SlidingTabIndicator extends LinearLayout {
        ...
        private void updateOrRecreateIndicatorAnimation(boolean recreateAnimation, final int position, int duration) {
            ...
            ValueAnimator.AnimatorUpdateListener updateListener = new ValueAnimator.AnimatorUpdateListener() {
                /* class com.google.android.material.tabs.TabLayout.SlidingTabIndicator.C07331 */
            ...
            if (recreateAnimation) {
                ...
                animator.addListener(new AnimatorListenerAdapter() {
                    /* class com.google.android.material.tabs.TabLayout.SlidingTabIndicator.C07342 */

...
public class MaterialAutoCompleteTextView extends AppCompatAutoCompleteTextView {
    ...
    public MaterialAutoCompleteTextView(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C0552R.attr.autoCompleteTextViewStyle);
    }
    ...
    public MaterialAutoCompleteTextView(Context context, AttributeSet attributeSet, int defStyleAttr) {
        ...
        TypedArray attributes = ThemeEnforcement.obtainStyledAttributes(context2, attributeSet, C0552R.styleable.MaterialAutoCompleteTextView, defStyleAttr, C0552R.style.Widget_AppCompat_AutoCompleteTextView, new int[0]);
        if (attributes.hasValue(C0552R.styleable.MaterialAutoCompleteTextView_android_inputType) && attributes.getInt(C0552R.styleable.MaterialAutoCompleteTextView_android_inputType, 0) == 0) {
            setKeyListener(null);
        }
        ...
        listPopupWindow.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            /* class com.google.android.material.textfield.MaterialAutoCompleteTextView.C07591 */

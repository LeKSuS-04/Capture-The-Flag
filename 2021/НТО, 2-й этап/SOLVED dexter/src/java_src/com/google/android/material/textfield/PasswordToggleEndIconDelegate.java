...
public class PasswordToggleEndIconDelegate extends EndIconDelegate {
    private final TextInputLayout.OnEditTextAttachedListener onEditTextAttachedListener = new TextInputLayout.OnEditTextAttachedListener() {
        /* class com.google.android.material.textfield.PasswordToggleEndIconDelegate.C07612 */
    ...
    private final TextInputLayout.OnEndIconChangedListener onEndIconChangedListener = new TextInputLayout.OnEndIconChangedListener() {
        /* class com.google.android.material.textfield.PasswordToggleEndIconDelegate.C07623 */
        ...
        public void onEndIconChanged(TextInputLayout textInputLayout, int previousIcon) {
            ...
            if (editText != null && previousIcon == 1) {
                ...
                editText.post(new Runnable() {
                    /* class com.google.android.material.textfield.PasswordToggleEndIconDelegate.C07623.RunnableC07631 */
    ...
    private final TextWatcher textWatcher = new TextWatcherAdapter() {
        /* class com.google.android.material.textfield.PasswordToggleEndIconDelegate.C07601 */
    ...
    public void initialize() {
        this.textInputLayout.setEndIconDrawable(AppCompatResources.getDrawable(this.context, C0552R.C0554drawable.design_password_eye));
        this.textInputLayout.setEndIconContentDescription(this.textInputLayout.getResources().getText(C0552R.string.password_toggle_content_description));
        this.textInputLayout.setEndIconOnClickListener(new View.OnClickListener() {
            /* class com.google.android.material.textfield.PasswordToggleEndIconDelegate.View$OnClickListenerC07644 */

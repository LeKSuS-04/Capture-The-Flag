...
class ChipTextInputComboView extends FrameLayout implements Checkable {
    ...
    public ChipTextInputComboView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        Chip chip2 = (Chip) inflater.inflate(C0552R.layout.material_time_chip, (ViewGroup) this, false);
        this.chip = chip2;
        TextInputLayout textInputLayout2 = (TextInputLayout) inflater.inflate(C0552R.layout.material_time_input, (ViewGroup) this, false);
        ...
        this.label = (TextView) findViewById(C0552R.C0555id.material_label);

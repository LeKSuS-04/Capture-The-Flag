...
public class ClockHandView extends View {
    ...
    public ClockHandView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, C0552R.styleable.ClockHandView, defStyleAttr, C0552R.style.Widget_MaterialComponents_TimePicker_Clock);
        this.circleRadius = a.getDimensionPixelSize(C0552R.styleable.ClockHandView_materialCircleRadius, 0);
        this.selectorRadius = a.getDimensionPixelSize(C0552R.styleable.ClockHandView_selectorSize, 0);
        Resources res = getResources();
        this.selectorStrokeWidth = res.getDimensionPixelSize(C0552R.dimen.material_clock_hand_stroke_width);
        this.centerDotRadius = (float) res.getDimensionPixelSize(C0552R.dimen.material_clock_hand_center_dot_radius);
        int selectorColor = a.getColor(C0552R.styleable.ClockHandView_clockHandColor, 0);
    ...
    public void setHandRotation(float degrees, boolean animate) {
        ...
        this.rotationAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            /* class com.google.android.material.timepicker.ClockHandView.C07731 */
        ...
        this.rotationAnimator.addListener(new AnimatorListenerAdapter() {
            /* class com.google.android.material.timepicker.ClockHandView.C07742 */
    ...
    private void drawSelector(Canvas canvas) {
        ...
        canvas.drawLine((float) xCenter, (float) yCenter, (float) (((int) (((double) lineLength) * cos)) + xCenter), (float) (((int) (((double) lineLength) * sin)) + yCenter), this.paint);

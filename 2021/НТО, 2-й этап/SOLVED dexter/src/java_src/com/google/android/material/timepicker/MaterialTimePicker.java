...
public final class MaterialTimePicker extends DialogFragment {
    ...
    public final Dialog onCreateDialog(Bundle bundle) {
        ...
        int surfaceColor = MaterialAttributes.resolveOrThrow(context, C0552R.attr.colorSurface, MaterialTimePicker.class.getCanonicalName());
        MaterialShapeDrawable background = new MaterialShapeDrawable(context, null, C0552R.attr.materialTimePickerStyle, C0552R.style.Widget_MaterialComponents_TimePicker);
        TypedArray a = context.obtainStyledAttributes(null, C0552R.styleable.MaterialTimePicker, C0552R.attr.materialTimePickerStyle, C0552R.style.Widget_MaterialComponents_TimePicker);
        this.clockIcon = a.getResourceId(C0552R.styleable.MaterialTimePicker_clockIcon, 0);
        this.keyboardIcon = a.getResourceId(C0552R.styleable.MaterialTimePicker_keyboardIcon, 0);
        a.recycle();
    ...
    public final View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ViewGroup root = (ViewGroup) layoutInflater.inflate(C0552R.layout.material_timepicker_dialog, viewGroup);
        TimePickerView timePickerView2 = (TimePickerView) root.findViewById(C0552R.C0555id.material_timepicker_view);
        this.timePickerView = timePickerView2;
        timePickerView2.setOnDoubleTapListener(new TimePickerView.OnDoubleTapListener() {
            /* class com.google.android.material.timepicker.MaterialTimePicker.C07751 */
        ...
        this.textInputStub = (ViewStub) root.findViewById(C0552R.C0555id.material_textinput_timepicker);
        this.modeButton = (MaterialButton) root.findViewById(C0552R.C0555id.material_timepicker_mode_button);
        TextView headerTitle = (TextView) root.findViewById(C0552R.C0555id.header_title);
        ...
        ((Button) root.findViewById(C0552R.C0555id.material_timepicker_ok_button)).setOnClickListener(new View.OnClickListener() {
            /* class com.google.android.material.timepicker.MaterialTimePicker.View$OnClickListenerC07762 */
        ...
        ((Button) root.findViewById(C0552R.C0555id.material_timepicker_cancel_button)).setOnClickListener(new View.OnClickListener() {
            /* class com.google.android.material.timepicker.MaterialTimePicker.View$OnClickListenerC07773 */
        ...
        this.modeButton.setOnClickListener(new View.OnClickListener() {
            /* class com.google.android.material.timepicker.MaterialTimePicker.View$OnClickListenerC07784 */
    ...
    private void updateInputMode(MaterialButton modeButton2) {
    ...
    private Pair<Integer, Integer> dataForMode(int mode) {
        switch (mode) {
            case 0:
                return new Pair<>(Integer.valueOf(this.keyboardIcon), Integer.valueOf(C0552R.string.material_timepicker_text_input_mode_description));
            case 1:
                return new Pair<>(Integer.valueOf(this.clockIcon), Integer.valueOf(C0552R.string.material_timepicker_clock_mode_description));
            default:
    ...
    private int getThemeResId() {
        ...
        TypedValue value = MaterialAttributes.resolve(requireContext(), C0552R.attr.materialTimePickerTheme);
        if (value == null) {
            return 0;
        }
        return value.data;

...
class RadialViewGroup extends ConstraintLayout {
    ...
    public RadialViewGroup(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        LayoutInflater.from(context).inflate(C0552R.layout.material_radial_view_group, this);
        ViewCompat.setBackground(this, createBackground());
        TypedArray a = context.obtainStyledAttributes(attrs, C0552R.styleable.RadialViewGroup, defStyleAttr, 0);
        this.radius = a.getDimensionPixelSize(C0552R.styleable.RadialViewGroup_materialCircleRadius, 0);
        this.updateLayoutParametersRunnable = new Runnable() {
            /* class com.google.android.material.timepicker.RadialViewGroup.RunnableC07791 */
    ...
    public void updateLayoutParams() {
        ...
        for (int i2 = 0; i2 < childCount; i2++) {
            ...
            if (childAt.getId() != C0552R.C0555id.circle_center && !shouldSkipView(childAt)) {
                constraintSet.constrainCircle(childAt.getId(), C0552R.C0555id.circle_center, this.radius, currentAngle);

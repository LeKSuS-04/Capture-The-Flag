...
public class TimeModel implements Parcelable {
    public static final Parcelable.Creator<TimeModel> CREATOR = new Parcelable.Creator<TimeModel>() {
        /* class com.google.android.material.timepicker.TimeModel.C07801 */
    ...
    public static String formatText(Resources resources, CharSequence text, String format2) {
        return String.format(resources.getConfiguration().locale, format2, Integer.valueOf(Integer.parseInt(String.valueOf(text))));
    }
}

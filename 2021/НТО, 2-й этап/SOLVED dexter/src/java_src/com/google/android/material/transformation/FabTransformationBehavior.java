...
public abstract class FabTransformationBehavior extends ExpandableTransformationBehavior {
    ...
    public AnimatorSet onCreateExpandedStateChangeAnimation(final View dependency, final View child, final boolean expanded, boolean isAnimating) {
        ...
        set.addListener(new AnimatorListenerAdapter() {
            /* class com.google.android.material.transformation.FabTransformationBehavior.C07921 */
        ...
        if ((child instanceof CircularRevealWidget) && (dependency instanceof ImageView)) {
            ...
            if (icon != null) {
                ...
                animator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
                    /* class com.google.android.material.transformation.FabTransformationBehavior.C07932 */
                ...
                listeners.add(new AnimatorListenerAdapter() {
                    /* class com.google.android.material.transformation.FabTransformationBehavior.C07943 */
        ...
        if (child instanceof CircularRevealWidget) {
            ...
            if (expanded) {
                ...
                animator2.addListener(new AnimatorListenerAdapter() {
                    /* class com.google.android.material.transformation.FabTransformationBehavior.C07954 */
    ...
    private ViewGroup calculateChildContentContainer(View view) {
        View childContentContainer = view.findViewById(C0552R.C0555id.mtrl_child_content_container);

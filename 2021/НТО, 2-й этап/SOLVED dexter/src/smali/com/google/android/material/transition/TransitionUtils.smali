...
.method static resolveThemeInterpolator(Landroid/content/Context;ILandroid/animation/TimeInterpolator;)Landroid/animation/TimeInterpolator;
    ...
    invoke-static {v1, v4}, Lcom/google/android/material/transition/TransitionUtils;->isEasingType(Ljava/lang/String;Ljava/lang/String;)Z

    move-result v5

    if-eqz v5, :cond_1

    invoke-static {v1, v4}, Lcom/google/android/material/transition/TransitionUtils;->getEasingContent(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v5, v6}, Lcom/google/android/material/transition/TransitionUtils;->getControlPoint([Ljava/lang/String;I)F

    move-result v6

    invoke-static {v5, v2}, Lcom/google/android/material/transition/TransitionUtils;->getControlPoint([Ljava/lang/String;I)F

    move-result v2

    const/4 v7, 0x2

    invoke-static {v5, v7}, Lcom/google/android/material/transition/TransitionUtils;->getControlPoint([Ljava/lang/String;I)F

    move-result v7

    invoke-static {v5, v3}, Lcom/google/android/material/transition/TransitionUtils;->getControlPoint([Ljava/lang/String;I)F
    ...
    invoke-static {v1, v2}, Lcom/google/android/material/transition/TransitionUtils;->isEasingType(Ljava/lang/String;Ljava/lang/String;)Z

    move-result v3

    if-eqz v3, :cond_2

    invoke-static {v1, v2}, Lcom/google/android/material/transition/TransitionUtils;->getEasingContent(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
